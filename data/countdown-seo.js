  ...
  'ramadan': {
    ar: {
      ...
      sections: [
        ...
        { h2: 'كيف تستخدم عدّاد رمضان؟',
          body: 'افتح هذه الصفحة في أيّ وقت لترى كم يومًا وساعةً ودقيقةً بقيت حتّى رمضان، والمؤقّت يُحدِّث نفسه تلقائيًّا دون إعادة تحميل. اسمح بالوصول إلى موقعك ليعكس العدّاد وأدوات مواقيت الصلاة المرتبطة مدينتك، فتحصل على وقتَي السحور والإفطار بدقّة عند دخول الشهر. استعِن بجدول السنوات للنظر إلى الأمام وتنظيم السفر أو الإجازة أو الدراسة حول الصيام، وتابِع لوحة القمر مع اقتراب نهاية شعبان لترقُّب الهلال الذي يُعلن البداية. احفظ الصفحة في المفضّلة وعُد إليها كلّ يوم لتشاهد الرقم يتناقص، وشاركها مع أهلك الذين يستعدّون للشهر معك.' },
        { h2: 'ماذا يعني تاريخ رمضان المتوقّع؟',
          body: 'التاريخ الميلاديّ المعروض هنا تاريخ متوقّع ومحسوب، أي تقدير دقيق لموعد بدء رمضان المرجَّح، وليس إعلانًا رسميًّا. فالشهر لا يبدأ فعليًّا إلّا بعد أن تُثبِت الجهة الشرعية في كلّ بلد رؤية هلال رمضان في نهاية شعبان، ولذلك قد يقع اليوم الأوّل الحقيقيّ قبل التقدير أو بعده بيوم. اعتبر العدّاد وجدول السنوات أدوات تخطيط تساعدك على الاستعداد مبكّرًا ريثما يصدر الإعلان الرسميّ في بلدك. ومع اقتراب الموعد تابِع أخبار بلدك ومسجدك حتّى يبدأ سحورك وأوّل صيامك في اليوم المعتمَد.' },
        { h2: 'التخطيط لشهر رمضان',
          body: 'قليل من الاستعداد يجعل الشهر أيسر. تابِع مواقيت الصلاة اليوميّة لتعرف بالضبط متى تُمسِك للسحور قبل الفجر ومتى تُفطر عند المغرب. راقِب القمر لترقُّب الهلال، ودوّن التاريخ الهجريّ لتعرف دائمًا موضعك من الشهر. ويفيدك أيضًا تنظيم الوجبات والنوم حول ساعات الصيام، ووضع أهداف بسيطة لتلاوة القرآن والصدقة، وترتيب العمل أو الدراسة قبل دخول الشهر. وعند انتهاء رمضان تتيح لك الأدوات نفسها العدّ التنازليّ لعيد الفطر. وتفتح الروابط ذات الصلة أدناه مواقيت الصلاة وحالة القمر والتاريخ الهجريّ وعدّاد العيد، فيكون كلّ ما تحتاجه على بُعد نقرة.' },
      ],
    },
    en: {
      titles: {
