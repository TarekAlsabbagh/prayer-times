...
module.exports = {
  ...
  'hijri-ny': {
    ar: {
      titles: {
        long:   'كم باقي على رأس السنة الهجرية {hy}؟ عد تنازلي ليوم 1 محرم',
        medium: 'كم باقي على رأس السنة الهجرية {hy}؟ | عد تنازلي',
        short:  'العد التنازلي لرأس السنة الهجرية {hy}',
      },
      desc: 'كم باقي على رأس السنة الهجرية {hy}؟ عد تنازلي مباشر لأول يوم من شهر محرم {hy} هـ مع التاريخ الميلادي المتوقع وجدول مواعيد السنوات القادمة.',
      sections: [
        { h2: 'متى تبدأ السنة الهجرية الجديدة؟',
          body: 'تبدأ السنة الهجرية الجديدة بأول يوم من شهر محرم، وهو أول شهور التقويم القمري الإسلامي. ويُحدَد دخوله برؤية هلال محرم بعد انقضاء شهر ذي الحجة، فإن لم يُرَ الهلال أُكمل ذو الحجة ثلاثين يومًا. وتتكون السنة الهجرية من اثني عشر شهرًا قمريًا تبدأ بمحرم وتنتهي بذي الحجة. ولأن الأشهر القمرية تتراوح بين 29 و30 يومًا، فإن موعد رأس السنة الهجرية على التقويم الميلادي يتغير كل عام ولا يثبت على فصل بعينه. ويعرض هذا العد التنازلي التاريخ الميلادي المتوقع لأول محرم {hy} هـ مع الأيام المتبقية حتى ذلك اليوم.' },
        { h2: 'لماذا يختلف موعد رأس السنة الهجرية بين الدول؟',
          body: 'تعتمد بعض الدول على رؤية الهلال بالعين المجردة، بينما تعتمد دول أخرى على الحساب الفلكي لتحديد بداية الشهر. وقد يُرى هلال محرم في منطقة قبل أخرى بيوم واحد، فيختلف إعلان أول محرم رسميًا بين بلد وآخر بمقدار يوم. ويعتمد هذا العد التنازلي تاريخ تقويم أم القرى الحسابي مرجعًا تقديريًا، ويبقى التأكيد النهائي لما تعلنه الجهة الشرعية في بلدك. ولهذا قد تجد فارقًا بسيطًا بين ما يعرضه العد هنا وما يُعلَن في بلدك، وهو أمر معتاد في المناسبات القمرية.' },
        { h2: 'كيف يعمل هذا العد التنازلي؟',
          body: 'يعرض المؤقت المباشر الأيام والساعات والدقائق والثواني المتبقية حتى بداية السنة الهجرية الجديدة المتوقعة بتوقيت بلدك. ويُدرِج جدول السنوات مواعيد أول محرم للأعوام القادمة كي تخطط مسبقًا، بينما تُظهر اللوحة القمرية طور القمر الحالي. وجميع التواريخ المعروضة تقديرية محسوبة فلكيًا، وقد تتقدم أو تتأخر يومًا واحدًا حسب ثبوت رؤية الهلال رسميًا.' },
        { h2: 'رأس السنة الهجرية والتقويم القمري',
          body: 'تتكون السنة الهجرية من نحو 354 يومًا، أي أقصر بنحو 11 يومًا من السنة الميلادية الشمسية البالغة 365 يومًا. ولهذا يتقدم رأس السنة الهجرية نحو 11 يومًا كل عام ميلادي، فيكون العد التنازلي مختلفًا في كل سنة. وعلى مدى نحو 33 عامًا يدور رأس السنة الهجرية عبر فصول السنة الأربعة كاملةً، فيأتي مرة في الصيف ومرة في الشتاء. وبسبب هذا الفارق قد يقع أول محرم مرتين داخل عام ميلادي واحد في حالات نادرة، ويظل ضبط موعده بالتقويم الميلادي بحاجة إلى متابعة سنوية دقيقة.' },
        { h2: 'كيف تستخدم عداد رأس السنة الهجرية',
          body: 'قراءة العد سهلة: يعمل المؤقت الكبير بتوقيت جهازك المحلي، فالأيام والساعات والدقائق التي تراها تعكس منطقتك الزمنية دون حاجة إلى أي تحويل. دون التاريخ الميلادي المتوقع لأول محرم {hy} هـ وأضفه إلى تقويمك حتى لا تمر المناسبة دون انتباه. وإن كنت تنسق مع الأهل أو مع جالية في بلد آخر، فتذكر أن تاريخهم الرسمي قد يتقدم أو يتأخر يوما واحدا، فشارك الموعد بوصفه متوقعا لا نهائيا. وعد إلى الصفحة كلما اقتربت ليلة الرؤية، إذ تتجدد الأرقام تلقائيا في كل مرة تفتحها.' },
        { h2: 'كيف تقرأ جدول السنوات القادمة',
          body: 'يجمع جدول السنوات مواعيد رؤوس السنوات الهجرية الخمس القادمة في عرض واحد لتخطط مبكرا. يبين العمود الأول السنة الهجرية، والثاني ما يقابلها من سنة ميلادية، والثالث التاريخ الميلادي المتوقع لأول محرم، بينما يشير العمود الأخير إلى أن كل تاريخ تقديري. والصف المميز هو أقرب رأس سنة، وبجانبه عدد الأيام المتبقية. وفي هذه الصفحة تكون السنة الهجرية وتاريخ أول محرم رابطين أيضا: افتح رقم السنة الهجرية لتصل إلى تقويم تلك السنة كاملا، أو افتح التاريخ لتطالع ذلك اليوم بعينه. ولأن التواريخ محسوبة فلكيا، فاعتبرها دليلا قريبا لا إعلانا نهائيا.' },
        { h2: 'ماذا تتابع قبل بداية السنة الهجرية',
          body: 'مع اقتراب نهاية ذي الحجة تظهر علامات تنبئ بقرب العام الجديد. فلوحة القمر في هذه الصفحة تميل نحو طور المحاق، وحين يختفي هلال الشهر القديم يترقب هلال محرم في الليلة التالية. وتابع إعلان جهة رؤية الهلال في بلدك، فأول محرم لا يثبت رسميا إلا بعد رؤية الهلال أو إكمال الشهر ثلاثين يوما. وهي أيضا لحظة مناسبة للاستعداد: يستقبل كثير من المسلمين العام الهجري بهدوء وتأمل ونية طيبة، ويصوم بعضهم يوم عاشوراء في العاشر من محرم بعد ذلك بقليل. وأبق العد مفتوحا لتعرف كم يوما بقي.' },
      ],
    },
    en: {
      titles: {
      ...
      sections: [
        ...
        { h2: 'How to use this Hijri New Year countdown',
          body: 'Reading the countdown is simple. The large timer counts down in the local time of your device, so the days, hours and minutes you see already reflect your own time zone — there is nothing to convert. Note the expected Gregorian date shown for 1 Muharram {hy} AH and add it to your calendar so the occasion does not slip past unnoticed. If you are coordinating with family or a community abroad, remember that their official date may fall a day earlier or later, so share it as an expected date rather than a fixed one. Come back as the sighting night approaches — the figures refresh automatically every time you open the page.' },
        { h2: 'How to read the upcoming-years table',
          body: 'The years table gathers the next five Hijri New Years in one view so you can plan ahead. The first column shows the Hijri year, the second its matching Gregorian year, and the third the expected Gregorian date of 1 Muharram, while the last column notes that every date is approximate. The highlighted row is the very next new year, with the days remaining shown beside it. On this page the Hijri-year figure and the 1 Muharram date are also links: open the Hijri year for a full calendar of that year, or open the date to view that exact day. Because the dates are calculated, treat them as a close guide rather than a final announcement.' },
        { h2: 'What to watch before the Hijri New Year begins',
          body: 'As the end of Dhul-Hijjah nears, a few signs show that the new year is almost here. The moon panel on this page moves toward the new-moon phase; once the old crescent fades, the Muharram crescent is sought on the following evening. Watch for the announcement from the moon-sighting authority in your country, because the first of Muharram is confirmed only after the crescent is seen or the month is completed at thirty days. It is also a good moment to prepare: many Muslims greet the new year quietly with reflection and good intentions, and some keep the fast of Ashura on the tenth of Muharram shortly afterwards. Keep the countdown open so you always know how many days remain.' },
      ],
    },
    fr: {
      titles: {
      ...
      sections: [
        ...
        { h2: 'Comment utiliser ce compte à rebours du Nouvel An hégirien',
          body: 'Lire le compte à rebours est simple. Le grand minuteur défile à l’heure locale de votre appareil : les jours, heures et minutes affichés reflètent déjà votre fuseau horaire, sans aucune conversion à faire. Notez la date grégorienne prévue pour le 1er Mouharram {hy} H et ajoutez-la à votre agenda afin que l’occasion ne passe pas inaperçue. Si vous vous coordonnez avec des proches ou une communauté à l’étranger, souvenez-vous que leur date officielle peut tomber un jour plus tôt ou plus tard ; partagez-la donc comme une date prévue et non définitive. Revenez à l’approche de la nuit d’observation : les chiffres se rafraîchissent automatiquement à chaque ouverture de la page.' },
        { h2: 'Comment lire le tableau des années à venir',
          body: 'Le tableau des années réunit les cinq prochains Nouvels Ans hégiriens en une seule vue pour planifier à l’avance. La première colonne indique l’année hégirienne, la deuxième l’année grégorienne correspondante et la troisième la date grégorienne prévue du 1er Mouharram, tandis que la dernière colonne rappelle que chaque date est approximative. La ligne mise en évidence correspond au tout prochain Nouvel An, avec les jours restants affichés à côté. Sur cette page, l’année hégirienne et la date du 1er Mouharram sont aussi des liens : ouvrez l’année hégirienne pour un calendrier complet de cette année, ou ouvrez la date pour consulter ce jour précis. Comme les dates sont calculées, considérez-les comme un repère proche plutôt qu’une annonce définitive.' },
        { h2: 'Que surveiller avant le début du Nouvel An hégirien',
          body: 'À l’approche de la fin de Dhou al-Hijja, quelques signes annoncent que la nouvelle année est proche. Le panneau lunaire de cette page se rapproche de la phase de nouvelle lune ; une fois l’ancien croissant disparu, le croissant de Mouharram est recherché le soir suivant. Guettez l’annonce de l’autorité d’observation du croissant dans votre pays, car le 1er Mouharram n’est confirmé qu’après l’observation du croissant ou l’achèvement du mois à trente jours. C’est aussi un bon moment pour se préparer : beaucoup de musulmans accueillent la nouvelle année dans le calme, par la réflexion et de bonnes intentions, et certains observent le jeûne de l’Achoura le dixième jour de Mouharram peu après. Gardez le compte à rebours ouvert pour toujours savoir combien de jours il reste.' },
      ],
    },
    tr: {
      titles: {
      ...
      sections: [
        ...
        { h2: 'Bu hicri yılbaşı geri sayımı nasıl kullanılır?',
          body: 'Geri sayımı okumak kolaydır. Büyük sayaç cihazınızın yerel saatine göre işler; gördüğünüz gün, saat ve dakikalar zaten kendi saat diliminizi yansıtır ve dönüştürmeye gerek yoktur. 1 Muharrem {hy} H için gösterilen beklenen miladi tarihi not edin ve bu vesileyi kaçırmamak için takviminize ekleyin. Yurt dışındaki ailenizle veya bir toplulukla görüşüyorsanız, onların resmî tarihinin bir gün önce ya da sonra olabileceğini unutmayın; bu yüzden tarihi kesin değil, beklenen bir tarih olarak paylaşın. Rüyet gecesi yaklaştıkça sayfaya tekrar bakın; sayfayı her açtığınızda rakamlar otomatik olarak güncellenir.' },
        { h2: 'Gelecek yıllar tablosu nasıl okunur?',
          body: 'Yıllar tablosu, önceden plan yapabilmeniz için önümüzdeki beş hicri yılbaşını tek bir görünümde toplar. İlk sütun hicri yılı, ikincisi buna karşılık gelen miladi yılı, üçüncüsü ise 1 Muharrem’in beklenen miladi tarihini gösterir; son sütun her tarihin tahmini olduğunu belirtir. Vurgulanan satır, hemen gelecek olan yılbaşıdır ve kalan günler yanında yer alır. Bu sayfada hicri yıl ve 1 Muharrem tarihi aynı zamanda birer bağlantıdır: o yılın tam takvimi için hicri yılı açın ya da o günü görmek için tarihi açın. Tarihler hesaplandığı için bunları kesin bir duyuru değil, yakın bir kılavuz olarak değerlendirin.' },
        { h2: 'Hicri yılbaşı başlamadan önce nelere dikkat etmeli?',
          body: 'Zilhicce’nin sonu yaklaştıkça birkaç işaret yeni yılın çok yakın olduğunu gösterir. Bu sayfadaki ay paneli yeni ay evresine doğru ilerler; eski hilal kaybolduktan sonra Muharrem hilali ertesi akşam aranır. Ülkenizdeki hilal gözlem merciinin duyurusunu takip edin; çünkü 1 Muharrem ancak hilal görüldükten ya da ay otuz güne tamamlandıktan sonra kesinleşir. Ayrıca hazırlık için de iyi bir zamandır: pek çok Müslüman yeni yılı sükûnetle, tefekkür ve güzel niyetlerle karşılar; kimileri de kısa süre sonra, Muharrem’in onuncu günü Aşure orucunu tutar. Kaç gün kaldığını her zaman bilmek için geri sayımı açık tutun.' },
      ],
    },
    ur: {
      titles: {
      ...
      sections: [
        ...
        { h2: 'اس ہجری نئے سال کے کاؤنٹ ڈاؤن کو کیسے استعمال کریں؟',
          body: 'کاؤنٹ ڈاؤن پڑھنا آسان ہے۔ بڑا ٹائمر آپ کے آلے کے مقامی وقت کے مطابق چلتا ہے، اس لیے جو دن، گھنٹے اور منٹ آپ دیکھتے ہیں وہ پہلے ہی آپ کے ٹائم زون کے مطابق ہوتے ہیں اور کسی تبدیلی کی ضرورت نہیں۔ 1 محرّم {hy} ہجری کے لیے دکھائی گئی متوقع میلادی تاریخ نوٹ کر لیں اور اسے اپنے کیلنڈر میں شامل کریں تاکہ یہ موقع نظر سے اوجھل نہ ہو۔ اگر آپ بیرونِ ملک اہلِ خانہ یا کسی جماعت کے ساتھ رابطہ کر رہے ہیں تو یاد رکھیں کہ ان کی سرکاری تاریخ ایک دن آگے یا پیچھے ہو سکتی ہے، اس لیے اسے حتمی کے بجائے متوقع تاریخ کے طور پر بتائیں۔ رویت کی رات قریب آنے پر صفحہ دوبارہ دیکھیں؛ جب بھی آپ اسے کھولیں گے، اعداد خود بخود تازہ ہو جائیں گے۔' },
        { h2: 'آنے والے سالوں کا جدول کیسے پڑھیں؟',
          body: 'سالوں کا جدول اگلے پانچ ہجری نئے سالوں کو ایک ہی جگہ جمع کر دیتا ہے تاکہ آپ پیشگی منصوبہ بندی کر سکیں۔ پہلا کالم ہجری سال، دوسرا اس کے مطابق میلادی سال، اور تیسرا 1 محرّم کی متوقع میلادی تاریخ دکھاتا ہے، جبکہ آخری کالم بتاتا ہے کہ ہر تاریخ تخمینی ہے۔ نمایاں کی گئی سطر بالکل اگلا نیا سال ہے، اور اس کے ساتھ باقی دن درج ہوتے ہیں۔ اس صفحے پر ہجری سال اور 1 محرّم کی تاریخ روابط بھی ہیں: اس سال کے مکمل تقویم کے لیے ہجری سال کھولیں، یا اس دن کو دیکھنے کے لیے تاریخ کھولیں۔ چونکہ تاریخیں حساب سے نکالی جاتی ہیں، انہیں حتمی اعلان کے بجائے ایک قریبی رہنمائی سمجھیں۔' },
        { h2: 'ہجری نیا سال شروع ہونے سے پہلے کن باتوں کا خیال رکھیں؟',
          body: 'ذوالحجہ کے اختتام کے قریب چند علامات بتاتی ہیں کہ نیا سال بہت قریب ہے۔ اس صفحے کا قمری پینل محاق کے مرحلے کی طرف بڑھتا ہے؛ جب پرانا چاند غائب ہو جاتا ہے تو اگلی شام محرّم کا چاند تلاش کیا جاتا ہے۔ اپنے ملک میں رویتِ ہلال کے ادارے کے اعلان پر نظر رکھیں، کیونکہ 1 محرّم اسی وقت طے ہوتا ہے جب چاند نظر آ جائے یا مہینہ تیس دن کا مکمل ہو جائے۔ یہ تیاری کا بھی اچھا موقع ہے: بہت سے مسلمان نئے ہجری سال کا استقبال سکون، غور و فکر اور اچھی نیت کے ساتھ کرتے ہیں، اور کچھ لوگ تھوڑی دیر بعد 10 محرّم کو عاشوراء کا روزہ رکھتے ہیں۔ کاؤنٹ ڈاؤن کھلا رکھیں تاکہ آپ کو ہمیشہ معلوم رہے کہ کتنے دن باقی ہیں۔' },
      ],
    },
    de: {
      titles: {
      ...
      sections: [
        ...
        { h2: 'Wie nutzt man diesen Countdown zum islamischen Neujahr?',
          body: 'Den Countdown zu lesen ist einfach. Der große Timer läuft in der lokalen Zeit Ihres Geräts; die angezeigten Tage, Stunden und Minuten spiegeln also bereits Ihre Zeitzone wider, ganz ohne Umrechnung. Notieren Sie das erwartete gregorianische Datum für den 1. Muharram {hy} AH und tragen Sie es in Ihren Kalender ein, damit der Anlass nicht unbemerkt vorübergeht. Wenn Sie sich mit Angehörigen oder einer Gemeinde im Ausland abstimmen, denken Sie daran, dass deren offizielles Datum einen Tag früher oder später liegen kann; geben Sie es daher als erwartetes und nicht als festes Datum weiter. Schauen Sie wieder vorbei, wenn die Nacht der Sichtung näher rückt – die Zahlen aktualisieren sich bei jedem Öffnen der Seite automatisch.' },
        { h2: 'Wie liest man die Tabelle der kommenden Jahre?',
          body: 'Die Jahrestabelle fasst die nächsten fünf islamischen Neujahre in einer Ansicht zusammen, damit Sie vorausplanen können. Die erste Spalte zeigt das Hidschri-Jahr, die zweite das entsprechende gregorianische Jahr und die dritte das erwartete gregorianische Datum des 1. Muharram, während die letzte Spalte darauf hinweist, dass jedes Datum ungefähr ist. Die hervorgehobene Zeile ist das unmittelbar nächste Neujahr, mit den verbleibenden Tagen daneben. Auf dieser Seite sind das Hidschri-Jahr und das Datum des 1. Muharram zugleich Links: Öffnen Sie das Hidschri-Jahr für einen vollständigen Kalender dieses Jahres oder das Datum, um genau diesen Tag anzusehen. Da die Daten berechnet sind, betrachten Sie sie als nahen Anhaltspunkt und nicht als endgültige Ankündigung.' },
        { h2: 'Worauf man vor dem islamischen Neujahr achten sollte',
          body: 'Wenn das Ende von Dhul-Hidscha naht, deuten einige Zeichen darauf hin, dass das neue Jahr fast da ist. Das Mondpanel auf dieser Seite bewegt sich auf die Neumondphase zu; sobald die alte Sichel verschwindet, wird am folgenden Abend nach der Muharram-Sichel gesucht. Achten Sie auf die Bekanntmachung der Mondsichtungs-Behörde in Ihrem Land, denn der 1. Muharram wird erst bestätigt, nachdem die Sichel gesehen oder der Monat auf dreißig Tage vervollständigt wurde. Es ist auch ein guter Moment zur Vorbereitung: Viele Muslime begrüßen das neue Jahr still mit Besinnung und guten Vorsätzen, und manche halten kurz darauf am zehnten Muharram das Aschura-Fasten. Halten Sie den Countdown geöffnet, damit Sie stets wissen, wie viele Tage bleiben.' },
      ],
    },
    id: {
      titles: {
      ...
      sections: [
        ...
        { h2: 'Cara menggunakan hitung mundur Tahun Baru Hijriah ini',
          body: 'Membaca hitung mundur ini mudah. Pengatur waktu besar berjalan dalam waktu setempat perangkat Anda, sehingga hari, jam, dan menit yang Anda lihat sudah mencerminkan zona waktu Anda tanpa perlu konversi. Catat tanggal Masehi yang diperkirakan untuk 1 Muharram {hy} H dan tambahkan ke kalender Anda agar momen ini tidak terlewat. Jika Anda berkoordinasi dengan keluarga atau komunitas di luar negeri, ingatlah bahwa tanggal resmi mereka bisa jatuh sehari lebih awal atau lebih lambat; jadi bagikan sebagai tanggal perkiraan, bukan tanggal pasti. Kunjungi lagi menjelang malam rukyat — angkanya diperbarui secara otomatis setiap kali Anda membuka halaman ini.' },
        { h2: 'Cara membaca tabel tahun-tahun mendatang',
          body: 'Tabel tahun mengumpulkan lima Tahun Baru Hijriah berikutnya dalam satu tampilan agar Anda dapat merencanakan lebih awal. Kolom pertama menampilkan tahun Hijriah, kedua tahun Masehi yang bersesuaian, dan ketiga tanggal Masehi yang diperkirakan untuk 1 Muharram, sementara kolom terakhir mengingatkan bahwa setiap tanggal bersifat perkiraan. Baris yang disorot adalah tahun baru yang paling dekat, dengan sisa hari tertera di sampingnya. Di halaman ini, tahun Hijriah dan tanggal 1 Muharram juga berupa tautan: buka tahun Hijriah untuk kalender lengkap tahun itu, atau buka tanggalnya untuk melihat hari tersebut. Karena tanggal-tanggal ini dihitung, perlakukan sebagai panduan yang mendekati, bukan pengumuman final.' },
        { h2: 'Apa yang perlu diperhatikan sebelum Tahun Baru Hijriah dimulai',
          body: 'Saat akhir Zulhijah mendekat, beberapa tanda menunjukkan bahwa tahun baru hampir tiba. Panel bulan di halaman ini bergerak menuju fase bulan baru; setelah hilal lama menghilang, hilal Muharram dicari pada petang berikutnya. Perhatikan pengumuman dari otoritas rukyatulhilal di negara Anda, karena 1 Muharram baru dipastikan setelah hilal terlihat atau bulan disempurnakan menjadi tiga puluh hari. Ini juga saat yang baik untuk bersiap: banyak muslim menyambut tahun baru dengan tenang melalui perenungan dan niat baik, dan sebagian menjalankan puasa Asyura pada tanggal sepuluh Muharram tak lama setelahnya. Biarkan hitung mundur tetap terbuka agar Anda selalu tahu berapa hari tersisa.' },
      ],
    },
    es: {
      titles: {
      ...
      sections: [
        ...
        { h2: 'Cómo usar esta cuenta atrás del Año Nuevo hégira',
          body: 'Leer la cuenta atrás es sencillo. El temporizador grande avanza según la hora local de tu dispositivo, así que los días, horas y minutos que ves ya reflejan tu zona horaria, sin ninguna conversión. Anota la fecha gregoriana prevista para el 1 de Muharram {hy} H y añádela a tu calendario para que la ocasión no pase desapercibida. Si te coordinas con familiares o una comunidad en el extranjero, recuerda que su fecha oficial puede caer un día antes o después; compártela, por tanto, como una fecha prevista y no definitiva. Vuelve a la página al acercarse la noche de observación: las cifras se actualizan automáticamente cada vez que la abres.' },
        { h2: 'Cómo leer la tabla de los próximos años',
          body: 'La tabla de años reúne los cinco próximos Años Nuevos hégira en una sola vista para que planifiques con antelación. La primera columna muestra el año hégira, la segunda su año gregoriano correspondiente y la tercera la fecha gregoriana prevista del 1 de Muharram, mientras que la última columna recuerda que cada fecha es aproximada. La fila resaltada es el próximo Año Nuevo más inmediato, con los días restantes a su lado. En esta página, el año hégira y la fecha del 1 de Muharram son también enlaces: abre el año hégira para ver un calendario completo de ese año, o abre la fecha para consultar ese día exacto. Como las fechas están calculadas, tómalas como una guía cercana y no como un anuncio definitivo.' },
        { h2: 'Qué observar antes de que comience el Año Nuevo hégira',
          body: 'A medida que se acerca el final de Dhul-Hiyya, algunas señales indican que el nuevo año está muy cerca. El panel lunar de esta página avanza hacia la fase de luna nueva; una vez que desaparece el creciente antiguo, el creciente de Muharram se busca la tarde siguiente. Atiende al anuncio de la autoridad de observación del creciente en tu país, pues el 1 de Muharram solo se confirma tras ver el creciente o completar el mes en treinta días. También es un buen momento para prepararse: muchos musulmanes reciben el nuevo año con calma, reflexión y buenas intenciones, y algunos observan el ayuno de la Ashura el décimo día de Muharram poco después. Mantén la cuenta atrás abierta para saber siempre cuántos días faltan.' },
      ],
    },
    bn: {
      titles: {
      ...
      sections: [
        ...
        { h2: 'এই হিজরি নববর্ষ কাউন্টডাউন কীভাবে ব্যবহার করবেন',
          body: 'কাউন্টডাউন পড়া সহজ। বড় টাইমারটি আপনার ডিভাইসের স্থানীয় সময় অনুযায়ী চলে, তাই আপনি যে দিন, ঘণ্টা ও মিনিট দেখছেন তা আগে থেকেই আপনার টাইম জোন অনুযায়ী—কোনো রূপান্তরের দরকার নেই। ১ মুহাররম {hy} হিজরির জন্য দেখানো প্রত্যাশিত গ্রেগরিয়ান তারিখটি নোট করে রাখুন এবং নিজের ক্যালেন্ডারে যোগ করুন যাতে উপলক্ষটি চোখ এড়িয়ে না যায়। বিদেশে থাকা পরিবার বা কোনো সম্প্রদায়ের সঙ্গে সমন্বয় করলে মনে রাখবেন, তাদের সরকারি তারিখ এক দিন আগে বা পরে হতে পারে; তাই এটি চূড়ান্ত নয়, প্রত্যাশিত তারিখ হিসেবে জানান। রুয়েতের রাত ঘনিয়ে এলে পৃষ্ঠাটি আবার দেখুন; প্রতিবার খুললেই সংখ্যাগুলো স্বয়ংক্রিয়ভাবে হালনাগাদ হয়।' },
        { h2: 'আগামী বছরগুলোর তালিকা কীভাবে পড়বেন',
          body: 'বছরের তালিকাটি আগামী পাঁচটি হিজরি নববর্ষকে একসঙ্গে এক জায়গায় দেখায় যাতে আপনি আগেভাগে পরিকল্পনা করতে পারেন। প্রথম কলামে হিজরি বছর, দ্বিতীয়টিতে তার সঙ্গে মিলে যাওয়া গ্রেগরিয়ান বছর, আর তৃতীয়টিতে ১ মুহাররমের প্রত্যাশিত গ্রেগরিয়ান তারিখ থাকে, আর শেষ কলামটি মনে করিয়ে দেয় যে প্রতিটি তারিখই আনুমানিক। হাইলাইট করা সারিটি একেবারে পরবর্তী নববর্ষ, আর তার পাশে বাকি দিন দেখানো থাকে। এই পৃষ্ঠায় হিজরি বছর ও ১ মুহাররমের তারিখ একই সঙ্গে লিংকও: সেই বছরের পূর্ণ পঞ্জিকা দেখতে হিজরি বছরটি খুলুন, অথবা সেই দিনটি দেখতে তারিখটি খুলুন। যেহেতু তারিখগুলো হিসাব করে বের করা, সেগুলোকে চূড়ান্ত ঘোষণা নয় বরং কাছাকাছি নির্দেশিকা হিসেবে ধরুন।' },
        { h2: 'হিজরি নববর্ষ শুরুর আগে কী কী লক্ষ রাখবেন',
          body: 'জিলহজ শেষ হওয়ার কাছাকাছি এলে কয়েকটি লক্ষণ বুঝিয়ে দেয় যে নতুন বছর প্রায় এসে গেছে। এই পৃষ্ঠার চাঁদ-প্যানেলটি অমাবস্যা দশার দিকে এগোয়; পুরোনো চাঁদ মিলিয়ে গেলে পরদিন সন্ধ্যায় মুহাররমের চাঁদ খোঁজা হয়। নিজ দেশে চাঁদ দেখার কর্তৃপক্ষের ঘোষণার দিকে খেয়াল রাখুন, কারণ ১ মুহাররম কেবল তখনই নিশ্চিত হয় যখন চাঁদ দেখা যায় বা মাস ত্রিশ দিনে পূর্ণ হয়। এটি প্রস্তুতির জন্যও ভালো সময়: অনেক মুসলিম শান্তভাবে, আত্মচিন্তা ও সৎ নিয়তের সঙ্গে নতুন বছরকে বরণ করেন, আর কেউ কেউ এর কিছু পরেই ১০ মুহাররম আশুরার রোজা রাখেন। কত দিন বাকি তা সবসময় জানতে কাউন্টডাউনটি খোলা রাখুন।' },
      ],
    },
    ms: {
      titles: {
      ...
      sections: [
        ...
        { h2: 'Cara menggunakan kira detik Tahun Baru Hijrah ini',
          body: 'Membaca kira detik ini mudah. Pemasa besar berjalan mengikut waktu tempatan peranti anda, jadi hari, jam dan minit yang anda lihat sudah pun mencerminkan zon waktu anda tanpa sebarang penukaran. Catat tarikh Masihi yang dijangka bagi 1 Muharam {hy} H dan tambahkannya ke kalendar anda supaya peristiwa ini tidak terlepas pandang. Jika anda berhubung dengan keluarga atau komuniti di luar negara, ingatlah bahawa tarikh rasmi mereka mungkin jatuh sehari lebih awal atau lewat; jadi kongsikannya sebagai tarikh dijangka dan bukan tarikh muktamad. Kembali semula menjelang malam rukyah — angkanya dikemas kini secara automatik setiap kali anda membuka halaman ini.' },
        { h2: 'Cara membaca jadual tahun-tahun mendatang',
          body: 'Jadual tahun mengumpulkan lima Tahun Baru Hijrah berikutnya dalam satu paparan supaya anda boleh merancang lebih awal. Lajur pertama menunjukkan tahun Hijrah, kedua tahun Masihi yang sepadan, dan ketiga tarikh Masihi yang dijangka bagi 1 Muharam, manakala lajur terakhir mengingatkan bahawa setiap tarikh adalah anggaran. Baris yang diserlahkan ialah Tahun Baru yang paling hampir, dengan baki hari dipaparkan di sebelahnya. Pada halaman ini, tahun Hijrah dan tarikh 1 Muharam turut menjadi pautan: buka tahun Hijrah untuk kalendar penuh tahun tersebut, atau buka tarikh untuk melihat hari itu. Oleh sebab tarikh ini dikira, anggaplah ia sebagai panduan hampir dan bukan pengumuman muktamad.' },
        { h2: 'Apa yang perlu diperhati sebelum Tahun Baru Hijrah bermula',
          body: 'Apabila penghujung Zulhijah menghampiri, beberapa tanda menunjukkan bahawa tahun baharu hampir tiba. Panel bulan pada halaman ini bergerak ke arah fasa bulan baharu; setelah anak bulan lama hilang, anak bulan Muharam dicari pada petang berikutnya. Perhatikan pengumuman pihak berkuasa rukyah anak bulan di negara anda, kerana 1 Muharam hanya disahkan selepas anak bulan kelihatan atau bulan disempurnakan kepada tiga puluh hari. Ini juga masa yang baik untuk bersedia: ramai umat Islam menyambut tahun baharu dengan tenang melalui muhasabah dan niat yang baik, dan sesetengahnya berpuasa Asyura pada sepuluh Muharam tidak lama selepas itu. Biarkan kira detik terbuka supaya anda sentiasa tahu berapa hari yang tinggal.' },
      ],
    },
  },
  ...
  'ramadan': {
    ar: {
      titles: {
        long:   'كم باقي على شهر رمضان {hy}؟ عد تنازلي لبداية الصيام',
        medium: 'كم باقي على رمضان {hy}؟ | عد تنازلي للصيام',
        short:  'العد التنازلي لرمضان {hy}',
      },
      desc: 'كم باقي على شهر رمضان {hy}؟ عد تنازلي مباشر لأول أيام الصيام في رمضان {hy} هـ مع التاريخ الميلادي المتوقع وجدول مواعيد السنوات القادمة.',
      sections: [
        { h2: 'متى يبدأ شهر رمضان؟',
          body: 'يبدأ شهر رمضان بثبوت رؤية هلاله بعد انقضاء شهر شعبان، فإن لم يُرَ الهلال أُكمل شعبان ثلاثين يومًا. ورمضان هو الشهر التاسع في التقويم الهجري، وفيه يصوم المسلمون من طلوع الفجر إلى غروب الشمس امتثالًا لأمر الله. وقد خص الله هذا الشهر بإنزال القرآن الكريم وبليلة القدر التي هي خير من ألف شهر، فيُكثر المسلمون فيه من قيام الليل وتلاوة القرآن والصدقة ويختمون نهاره بفطورٍ يجمع الأهل. ولأن الأشهر القمرية تتراوح بين 29 و30 يومًا، يتغير موعد بداية رمضان على التقويم الميلادي كل عام. ويعرض هذا العد التنازلي التاريخ الميلادي المتوقع لأول أيام رمضان {hy} هـ مع الأيام المتبقية حتى ذلك اليوم.' },
        { h2: 'لماذا يختلف موعد رمضان بين الدول؟',
          body: 'تعتمد بعض الدول على رؤية هلال رمضان بالعين المجردة، بينما تعتمد دول أخرى على الحساب الفلكي لتحديد بداية الشهر. وقد يُرى الهلال في منطقة قبل أخرى بيوم واحد، فيبدأ الصيام رسميًا في بلد قبل آخر بمقدار يوم. ويعتمد هذا العد التنازلي تاريخ تقويم أم القرى الحسابي مرجعًا تقديريًا، ويبقى التأكيد النهائي لما تعلنه الجهة الشرعية في بلدك، فلا تثريب إن وجدت فارق يوم بين بلدك وما يُعرض هنا. ويبقى الأصل أن شهر الصيام واحد تشترك فيه الأمة جمعاء، وإن تفاوتت ساعة بدايته بين المشارق والمغارب.' },
        { h2: 'كيف يعمل هذا العد التنازلي؟',
          body: 'يعرض المؤقت المباشر الأيام والساعات والدقائق والثواني المتبقية حتى بداية رمضان المتوقعة بتوقيت بلدك. ويُدرِج جدول السنوات مواعيد بداية رمضان للأعوام القادمة كي تخطط للصيام والعبادة مسبقًا، بينما تُظهر اللوحة القمرية طور القمر الحالي. وجميع التواريخ المعروضة تقديرية محسوبة فلكيًا، وقد تتقدم أو تتأخر يومًا واحدًا حسب ثبوت رؤية الهلال رسميًا.' },
        { h2: 'رمضان والتقويم القمري',
          body: 'يقع رمضان في الشهر التاسع من السنة الهجرية القمرية التي تبلغ نحو 354 يومًا، أي أقصر بنحو 11 يومًا من السنة الميلادية الشمسية. ولهذا يتقدم رمضان نحو 11 يومًا كل عام ميلادي، فيمر عبر فصول السنة جميعها على مدى نحو 33 عامًا. ولذلك تطول ساعات الصيام أو تقصر تبعًا للفصل الذي يقع فيه رمضان وموقعك على الأرض، فيصوم أهل الشمال نهارًا طويلًا في الصيف وقصيرًا في الشتاء. ولهذا تفيدك معرفة موعد رمضان مبكرًا في تنظيم مواعيد السحور والإفطار والعمل والدراسة، وفي الاستعداد روحيًا وبدنيًا قبل دخول الشهر الكريم بوقتٍ كافٍ.' },
        { h2: 'كيف تستخدم عداد رمضان؟',
          body: 'افتح هذه الصفحة في أي وقت لترى كم يومًا وساعةً ودقيقةً بقيت حتى رمضان، والمؤقت يُحدِث نفسه تلقائيًا دون إعادة تحميل. اسمح بالوصول إلى موقعك ليعكس العداد وأدوات مواقيت الصلاة المرتبطة مدينتك، فتحصل على وقتَي السحور والإفطار بدقة عند دخول الشهر. استعِن بجدول السنوات للنظر إلى الأمام وتنظيم السفر أو الإجازة أو الدراسة حول الصيام، وتابِع لوحة القمر مع اقتراب نهاية شعبان لترقُب الهلال الذي يُعلن البداية. احفظ الصفحة في المفضلة وعُد إليها كل يوم لتشاهد الرقم يتناقص، وشاركها مع أهلك الذين يستعدون للشهر معك.' },
        { h2: 'ماذا يعني تاريخ رمضان المتوقع؟',
          body: 'التاريخ الميلادي المعروض هنا تاريخ متوقع ومحسوب، أي تقدير دقيق لموعد بدء رمضان المرجَح، وليس إعلانًا رسميًا. فالشهر لا يبدأ فعليًا إلا بعد أن تُثبِت الجهة الشرعية في كل بلد رؤية هلال رمضان في نهاية شعبان، ولذلك قد يقع اليوم الأول الحقيقي قبل التقدير أو بعده بيوم. اعتبر العداد وجدول السنوات أدوات تخطيط تساعدك على الاستعداد مبكرًا ريثما يصدر الإعلان الرسمي في بلدك. ومع اقتراب الموعد تابِع أخبار بلدك ومسجدك حتى يبدأ سحورك وأول صيامك في اليوم المعتمَد.' },
        { h2: 'التخطيط لشهر رمضان',
          body: 'قليل من الاستعداد يجعل الشهر أيسر. تابِع مواقيت الصلاة اليومية لتعرف بالضبط متى تُمسِك للسحور قبل الفجر ومتى تُفطر عند المغرب. راقِب القمر لترقُب الهلال، ودون التاريخ الهجري لتعرف دائمًا موضعك من الشهر. ويفيدك أيضًا تنظيم الوجبات والنوم حول ساعات الصيام، ووضع أهداف بسيطة لتلاوة القرآن والصدقة، وترتيب العمل أو الدراسة قبل دخول الشهر. وعند انتهاء رمضان تتيح لك الأدوات نفسها العد التنازلي لعيد الفطر. وتفتح الروابط ذات الصلة أدناه مواقيت الصلاة وحالة القمر والتاريخ الهجري وعداد العيد، فيكون كل ما تحتاجه على بُعد نقرة.' },
      ],
    },
    en: {
      titles: {
      ...
      sections: [
        ...
        { h2: 'How to use the Ramadan countdown',
          body: 'Open this page any time to see how many days, hours and minutes remain until Ramadan, and the timer keeps refreshing on its own without a reload. Allow location access so the countdown and the linked prayer-time tools reflect your own city, giving you accurate suhoor and iftar times once the month starts. Use the years table to look ahead and arrange travel, leave or study around the fast, and check the moon panel as the end of Shaban nears to follow the crescent that marks the beginning. Bookmark the page and return each day to watch the number fall, and share it with family who are preparing for the month alongside you.' },
        { h2: 'What does the expected Ramadan date mean?',
          body: 'The Gregorian date shown here is an expected, calculated date — a careful estimate of when Ramadan is likely to begin, not an official ruling. In practice the month starts only after the religious authority in each country confirms the sighting of the new crescent at the end of Shaban, so the real first day can fall a day earlier or later than the estimate. Treat the countdown and the years table as planning aids that help you prepare early while you wait for the announcement in your own country. As the day approaches, follow local news and your mosque so your suhoor and first fast begin on the confirmed date.' },
        { h2: 'Planning for Ramadan',
          body: 'A little preparation makes the month smoother. Follow your daily prayer times so you know exactly when to stop for suhoor before Fajr and when to break your fast at Maghrib. Watch the moon to anticipate the crescent, and note the Hijri date so you always know where you stand in the month. It also helps to plan meals and sleep around fasting hours, set simple goals for reading the Quran and giving charity, and organise work or study before the month begins. When Ramadan ends, the same tools let you count down to Eid al-Fitr. The related links below open prayer times, the moon phase, the Hijri date and the Eid countdown, so everything you need is one tap away.' },
      ],
    },
    fr: {
      titles: {
      ...
      sections: [
        ...
        { h2: 'Comment utiliser le compte à rebours du Ramadan ?',
          body: 'Ouvrez cette page à tout moment pour voir combien de jours, d’heures et de minutes il reste avant le Ramadan ; le minuteur se met à jour tout seul, sans rechargement. Autorisez la localisation afin que le compte à rebours et les outils d’horaires de prière liés reflètent votre propre ville, vous donnant des heures de souhour et d’iftar précises une fois le mois commencé. Servez-vous du tableau des années pour anticiper et organiser vos voyages, congés ou études autour du jeûne, et consultez le panneau lunaire à l’approche de la fin de Chaabane pour suivre le croissant qui marque le début. Ajoutez la page aux favoris et revenez chaque jour voir le nombre diminuer, puis partagez-la avec vos proches qui se préparent au mois avec vous.' },
        { h2: 'Que signifie la date prévue du Ramadan ?',
          body: 'La date grégorienne affichée ici est une date prévue et calculée — une estimation soignée du début probable du Ramadan, et non une annonce officielle. En pratique, le mois ne commence qu’après que l’autorité religieuse de chaque pays a confirmé l’observation du nouveau croissant à la fin de Chaabane, de sorte que le vrai premier jour peut tomber un jour plus tôt ou plus tard que l’estimation. Considérez le compte à rebours et le tableau des années comme des aides à la planification qui vous permettent de vous préparer tôt en attendant l’annonce dans votre pays. À l’approche du jour, suivez les informations locales et votre mosquée afin que votre souhour et votre premier jeûne commencent à la date confirmée.' },
        { h2: 'Se préparer au Ramadan',
          body: 'Un peu de préparation rend le mois plus serein. Suivez vos horaires de prière quotidiens pour savoir exactement quand cesser de manger pour le souhour avant le Fajr et quand rompre le jeûne au Maghrib. Observez la lune pour anticiper le croissant, et notez la date hégirienne afin de toujours savoir où vous en êtes dans le mois. Il est utile aussi d’organiser les repas et le sommeil autour des heures de jeûne, de fixer des objectifs simples de lecture du Coran et d’aumône, et de préparer le travail ou les études avant le début du mois. Lorsque le Ramadan se termine, les mêmes outils vous permettent de compter les jours jusqu’à l’Aïd al-Fitr. Les liens connexes ci-dessous ouvrent les horaires de prière, la phase de la lune, la date hégirienne et le compte à rebours de l’Aïd, pour que tout soit à portée de clic.' },
      ],
    },
    tr: {
      titles: {
      ...
      sections: [
        ...
        { h2: 'Ramazan geri sayımı nasıl kullanılır?',
          body: 'Ramazan’a kaç gün, saat ve dakika kaldığını görmek için bu sayfayı istediğiniz zaman açın; sayaç yeniden yükleme gerektirmeden kendini günceller. Konum erişimine izin verin; böylece geri sayım ve bağlantılı namaz vakti araçları kendi şehrinizi yansıtır ve ay başladığında doğru sahur ile iftar vakitlerini verir. İleriyi görmek ve seyahat, izin ya da öğrenimi oruca göre düzenlemek için yıllar tablosundan yararlanın; Şaban’ın sonu yaklaşırken başlangıcı müjdeleyen hilali izlemek için ay paneline bakın. Sayfayı yer imlerine ekleyin ve sayının azalışını görmek için her gün geri dönün, ayrıca aya sizinle birlikte hazırlanan ailenizle paylaşın.' },
        { h2: 'Beklenen Ramazan tarihi ne anlama gelir?',
          body: 'Burada gösterilen miladi tarih, beklenen ve hesaplanmış bir tarihtir; yani Ramazan’ın büyük olasılıkla ne zaman başlayacağına dair özenli bir tahmindir, resmî bir ilan değildir. Uygulamada ay, ancak her ülkedeki dinî merci Şaban’ın sonunda yeni hilalin görüldüğünü doğruladıktan sonra başlar; bu yüzden gerçek ilk gün tahminden bir gün önce ya da sonra olabilir. Geri sayımı ve yıllar tablosunu, kendi ülkenizdeki resmî duyuruyu beklerken erkenden hazırlanmanıza yardımcı olan planlama araçları olarak görün. Gün yaklaştıkça yerel haberleri ve caminizi takip edin ki sahurunuz ve ilk orucunuz onaylanan tarihte başlasın.' },
        { h2: 'Ramazan için hazırlık',
          body: 'Biraz hazırlık ayı kolaylaştırır. Günlük namaz vakitlerinizi takip edin ki Fecir’den önce sahur için ne zaman duracağınızı ve Mağrib’de orucu ne zaman açacağınızı tam olarak bilin. Hilali önceden sezmek için ayı gözleyin ve ayın neresinde olduğunuzu her zaman bilmek için hicri tarihi not edin. Öğünleri ve uykuyu oruç saatlerine göre düzenlemek, Kur’an okuma ve sadaka için basit hedefler koymak, işi veya öğrenimi ay başlamadan planlamak da yardımcı olur. Ramazan bittiğinde aynı araçlar Ramazan Bayramı’na kadar geri saymanızı sağlar. Aşağıdaki ilgili bağlantılar namaz vakitlerini, ay evresini, hicri tarihi ve bayram geri sayımını açar; böylece ihtiyacınız olan her şey bir dokunuş uzağınızdadır.' },
      ],
    },
    ur: {
      titles: {
      ...
      sections: [
        ...
        { h2: 'رمضان کاؤنٹ ڈاؤن کیسے استعمال کریں؟',
          body: 'رمضان میں کتنے دن، گھنٹے اور منٹ باقی ہیں یہ دیکھنے کے لیے یہ صفحہ کسی بھی وقت کھولیں؛ ٹائمر بغیر ری لوڈ کیے خود کو اپ ڈیٹ کرتا رہتا ہے۔ مقام تک رسائی کی اجازت دیں تاکہ کاؤنٹ ڈاؤن اور منسلک نماز اوقات کے اوزار آپ کے اپنے شہر کی عکاسی کریں اور مہینہ شروع ہوتے ہی درست سحری و افطاری کے اوقات دیں۔ آگے کی منصوبہ بندی اور سفر، چھٹی یا تعلیم کو روزے کے گرد ترتیب دینے کے لیے سالوں کے جدول سے مدد لیں، اور شعبان کے اختتام کے قریب آغاز کا اعلان کرنے والے ہلال کو دیکھنے کے لیے چاند پینل پر نظر رکھیں۔ صفحے کو محفوظ کریں اور ہر روز واپس آ کر عدد کو گھٹتا دیکھیں، اور اسے اپنے گھر والوں کے ساتھ شیئر کریں جو آپ کے ساتھ مہینے کی تیاری کر رہے ہیں۔' },
        { h2: 'رمضان کی متوقع تاریخ کا کیا مطلب ہے؟',
          body: 'یہاں دکھائی گئی میلادی تاریخ ایک متوقع اور حسابی تاریخ ہے، یعنی رمضان کے ممکنہ آغاز کا محتاط تخمینہ، کوئی سرکاری اعلان نہیں۔ عملاً مہینہ اُسی وقت شروع ہوتا ہے جب ہر ملک کا دینی ادارہ شعبان کے اختتام پر نئے ہلال کی رویت کی تصدیق کرے، اسی لیے اصل پہلا دن تخمینے سے ایک دن پہلے یا بعد ہو سکتا ہے۔ کاؤنٹ ڈاؤن اور سالوں کے جدول کو منصوبہ بندی کا ذریعہ سمجھیں جو آپ کو اپنے ملک کے سرکاری اعلان کے انتظار میں پہلے سے تیاری میں مدد دیتے ہیں۔ تاریخ قریب آنے پر مقامی خبروں اور اپنی مسجد کو دیکھتے رہیں تاکہ آپ کی سحری اور پہلا روزہ معتمد دن پر شروع ہو۔' },
        { h2: 'رمضان کی منصوبہ بندی',
          body: 'تھوڑی سی تیاری مہینے کو آسان بنا دیتی ہے۔ روزانہ نماز کے اوقات دیکھتے رہیں تاکہ آپ کو معلوم ہو کہ فجر سے پہلے سحری کے لیے کب رکنا ہے اور مغرب پر روزہ کب کھولنا ہے۔ ہلال کا اندازہ لگانے کے لیے چاند پر نظر رکھیں، اور ہجری تاریخ نوٹ کریں تاکہ آپ کو مہینے میں اپنا مقام ہمیشہ معلوم رہے۔ کھانوں اور نیند کو روزے کے اوقات کے گرد ترتیب دینا، قرآن کی تلاوت اور صدقے کے سادہ اہداف مقرر کرنا، اور مہینہ شروع ہونے سے پہلے کام یا تعلیم کی منصوبہ بندی کرنا بھی مفید ہے۔ رمضان ختم ہونے پر یہی اوزار آپ کو عید الفطر تک الٹی گنتی کی سہولت دیتے ہیں۔ نیچے دیے گئے متعلقہ روابط نماز کے اوقات، چاند کا مرحلہ، ہجری تاریخ اور عید کاؤنٹ ڈاؤن کھولتے ہیں، تاکہ آپ کی ضرورت کی ہر چیز ایک کلک کی دوری پر ہو۔' },
      ],
    },
    de: {
      titles: {
      ...
      sections: [
        ...
        { h2: 'Wie nutzt man den Ramadan-Countdown?',
          body: 'Öffnen Sie diese Seite jederzeit, um zu sehen, wie viele Tage, Stunden und Minuten bis zum Ramadan verbleiben; der Timer aktualisiert sich von selbst, ohne neu zu laden. Erlauben Sie den Standortzugriff, damit der Countdown und die verknüpften Gebetszeiten-Werkzeuge Ihre eigene Stadt widerspiegeln und Ihnen zu Monatsbeginn genaue Suhur- und Iftar-Zeiten liefern. Nutzen Sie die Jahrestabelle, um vorauszuplanen und Reisen, Urlaub oder Studium um das Fasten herum zu organisieren, und schauen Sie zum Ende des Schaban auf das Mondpanel, um die Sichel zu verfolgen, die den Beginn ankündigt. Setzen Sie ein Lesezeichen und kehren Sie täglich zurück, um die Zahl sinken zu sehen, und teilen Sie die Seite mit Angehörigen, die sich mit Ihnen auf den Monat vorbereiten.' },
        { h2: 'Was bedeutet das erwartete Ramadan-Datum?',
          body: 'Das hier angezeigte gregorianische Datum ist ein erwartetes, berechnetes Datum — eine sorgfältige Schätzung des wahrscheinlichen Ramadan-Beginns, keine offizielle Ankündigung. Tatsächlich beginnt der Monat erst, nachdem die religiöse Autorität jedes Landes die Sichtung der neuen Sichel am Ende des Schaban bestätigt hat, weshalb der wahre erste Tag einen Tag früher oder später als die Schätzung liegen kann. Betrachten Sie den Countdown und die Jahrestabelle als Planungshilfen, mit denen Sie sich frühzeitig vorbereiten, während Sie auf die Ankündigung in Ihrem Land warten. Verfolgen Sie mit näher rückendem Tag die lokalen Nachrichten und Ihre Moschee, damit Ihr Suhur und Ihr erstes Fasten am bestätigten Datum beginnen.' },
        { h2: 'Planung für den Ramadan',
          body: 'Ein wenig Vorbereitung macht den Monat leichter. Verfolgen Sie Ihre täglichen Gebetszeiten, damit Sie genau wissen, wann Sie vor dem Fadschr mit dem Suhur aufhören und wann Sie beim Maghrib das Fasten brechen. Beobachten Sie den Mond, um die Sichel vorherzusehen, und notieren Sie das Hidschri-Datum, damit Sie stets wissen, wo Sie im Monat stehen. Ebenso hilft es, Mahlzeiten und Schlaf um die Fastenzeiten zu planen, einfache Ziele für die Koranlesung und das Spenden zu setzen und Arbeit oder Studium vor Monatsbeginn zu organisieren. Wenn der Ramadan endet, ermöglichen dieselben Werkzeuge den Countdown bis zum Fest des Fastenbrechens. Die verwandten Links unten öffnen Gebetszeiten, Mondphase, Hidschri-Datum und den Fest-Countdown, sodass alles nur einen Klick entfernt ist.' },
      ],
    },
    id: {
      titles: {
      ...
      sections: [
        ...
        { h2: 'Cara menggunakan hitung mundur Ramadan',
          body: 'Buka halaman ini kapan saja untuk melihat berapa hari, jam, dan menit tersisa menuju Ramadan; pengatur waktu memperbarui dirinya sendiri tanpa perlu memuat ulang. Izinkan akses lokasi agar hitung mundur beserta alat waktu salat yang tertaut mencerminkan kota Anda sendiri, sehingga memberi waktu sahur dan berbuka yang akurat begitu bulan dimulai. Manfaatkan tabel tahun untuk merencanakan ke depan dan mengatur perjalanan, cuti, atau studi di sekitar puasa, dan lihat panel bulan menjelang akhir Syaban untuk mengikuti hilal yang menandai permulaan. Tandai halaman ini dan kembalilah setiap hari untuk melihat angkanya menyusut, lalu bagikan kepada keluarga yang bersiap menyambut bulan ini bersama Anda.' },
        { h2: 'Apa arti tanggal Ramadan yang diperkirakan?',
          body: 'Tanggal Masehi yang ditampilkan di sini adalah tanggal perkiraan hasil perhitungan — sebuah taksiran cermat tentang kapan Ramadan kemungkinan dimulai, bukan pengumuman resmi. Pada praktiknya bulan baru dimulai setelah otoritas keagamaan di tiap negara memastikan rukyat hilal baru pada akhir Syaban, sehingga hari pertama yang sebenarnya bisa jatuh sehari lebih awal atau lebih lambat daripada perkiraan. Perlakukan hitung mundur dan tabel tahun sebagai alat bantu perencanaan yang membantu Anda bersiap lebih dini sambil menunggu pengumuman di negara Anda. Menjelang harinya, ikuti berita setempat dan masjid Anda agar sahur dan puasa pertama dimulai pada tanggal yang ditetapkan.' },
        { h2: 'Merencanakan Ramadan',
          body: 'Sedikit persiapan membuat bulan ini terasa lebih ringan. Ikuti waktu salat harian Anda agar tahu persis kapan berhenti untuk sahur sebelum Subuh dan kapan berbuka saat Magrib. Amati bulan untuk memperkirakan hilal, dan catat tanggal Hijriah agar Anda selalu tahu posisi Anda dalam bulan ini. Membantu pula mengatur makan dan tidur di sekitar jam puasa, menetapkan target sederhana membaca Al-Qur’an dan bersedekah, serta menata pekerjaan atau studi sebelum bulan dimulai. Saat Ramadan berakhir, alat yang sama memungkinkan Anda menghitung mundur menuju Idulfitri. Tautan terkait di bawah membuka waktu salat, fase bulan, tanggal Hijriah, dan hitung mundur Idulfitri, sehingga semua yang Anda perlukan cukup satu ketukan.' },
      ],
    },
    es: {
      titles: {
      ...
      sections: [
        ...
        { h2: '¿Cómo usar la cuenta atrás del Ramadán?',
          body: 'Abre esta página cuando quieras para ver cuántos días, horas y minutos faltan para el Ramadán; el temporizador se actualiza solo, sin necesidad de recargar. Permite el acceso a la ubicación para que la cuenta atrás y las herramientas de horarios de oración vinculadas reflejen tu propia ciudad, dándote horas precisas de sahur e iftar en cuanto empiece el mes. Usa la tabla de años para anticiparte y organizar viajes, permisos o estudios en torno al ayuno, y consulta el panel lunar al acercarse el final de Shaabán para seguir el creciente que marca el inicio. Guarda la página en favoritos y vuelve cada día para ver bajar el número, y compártela con los tuyos que se preparan para el mes contigo.' },
        { h2: '¿Qué significa la fecha prevista del Ramadán?',
          body: 'La fecha gregoriana que se muestra aquí es una fecha prevista y calculada: una estimación cuidadosa de cuándo es probable que empiece el Ramadán, no un anuncio oficial. En la práctica, el mes solo comienza después de que la autoridad religiosa de cada país confirme el avistamiento del nuevo creciente al final de Shaabán, por lo que el verdadero primer día puede caer un día antes o después de la estimación. Considera la cuenta atrás y la tabla de años como ayudas de planificación que te permiten prepararte con tiempo mientras esperas el anuncio en tu país. A medida que se acerque el día, sigue las noticias locales y tu mezquita para que tu sahur y tu primer ayuno comiencen en la fecha confirmada.' },
        { h2: 'Planificar el Ramadán',
          body: 'Un poco de preparación hace el mes más llevadero. Sigue tus horarios de oración diarios para saber exactamente cuándo dejar de comer para el sahur antes del Fayr y cuándo romper el ayuno en el Magrib. Observa la luna para anticipar el creciente y anota la fecha hégira para saber siempre en qué punto del mes estás. También ayuda organizar las comidas y el sueño en torno a las horas de ayuno, fijar metas sencillas de lectura del Corán y de limosna, y ordenar el trabajo o los estudios antes de que empiece el mes. Cuando el Ramadán termina, las mismas herramientas te permiten contar los días hasta el Eid al-Fitr. Los enlaces relacionados de abajo abren los horarios de oración, la fase de la luna, la fecha hégira y la cuenta atrás del Eid, para que todo lo que necesitas esté a un toque.' },
      ],
    },
    bn: {
      titles: {
      ...
      sections: [
        ...
        { h2: 'রমজান কাউন্টডাউন কীভাবে ব্যবহার করবেন?',
          body: 'রমজান আসতে কত দিন, ঘণ্টা ও মিনিট বাকি তা দেখতে যেকোনো সময় এই পৃষ্ঠাটি খুলুন; টাইমারটি রিলোড ছাড়াই নিজে নিজে হালনাগাদ হতে থাকে। অবস্থান ব্যবহারের অনুমতি দিন যাতে কাউন্টডাউন ও সংযুক্ত নামাজের সময়ের সরঞ্জামগুলো আপনার নিজের শহরকে প্রতিফলিত করে এবং মাস শুরু হলে সঠিক সেহরি ও ইফতারের সময় দেয়। সামনের পরিকল্পনা এবং ভ্রমণ, ছুটি বা পড়াশোনা রোজার সঙ্গে সাজাতে বছরের তালিকাটি কাজে লাগান, আর শাবানের শেষ ঘনিয়ে এলে শুরুর ঘোষণাকারী হিলাল অনুসরণ করতে চাঁদ-প্যানেল দেখুন। পৃষ্ঠাটি বুকমার্ক করে প্রতিদিন ফিরে এসে সংখ্যা কমতে দেখুন, আর যাঁরা আপনার সঙ্গে মাসটির প্রস্তুতি নিচ্ছেন সেই পরিবারের সঙ্গে শেয়ার করুন।' },
        { h2: 'রমজানের প্রত্যাশিত তারিখ মানে কী?',
          body: 'এখানে দেখানো গ্রেগরিয়ান তারিখটি একটি প্রত্যাশিত ও হিসাবকৃত তারিখ — রমজান কখন শুরু হতে পারে তার একটি যত্নশীল অনুমান, কোনো সরকারি ঘোষণা নয়। বাস্তবে প্রতিটি দেশের ধর্মীয় কর্তৃপক্ষ শাবানের শেষে নতুন হিলাল দেখার বিষয়টি নিশ্চিত করার পরেই মাস শুরু হয়, তাই প্রকৃত প্রথম দিন অনুমানের চেয়ে এক দিন আগে বা পরে হতে পারে। কাউন্টডাউন ও বছরের তালিকাকে পরিকল্পনার সহায়ক হিসেবে ধরুন, যা আপনার দেশের সরকারি ঘোষণার অপেক্ষায় আগেভাগে প্রস্তুত হতে সাহায্য করে। দিন ঘনিয়ে এলে স্থানীয় খবর ও আপনার মসজিদ অনুসরণ করুন যাতে আপনার সেহরি ও প্রথম রোজা নির্ধারিত দিনেই শুরু হয়।' },
        { h2: 'রমজানের পরিকল্পনা',
          body: 'সামান্য প্রস্তুতি মাসটিকে সহজ করে তোলে। প্রতিদিনের নামাজের সময় অনুসরণ করুন যাতে ঠিক জানেন কখন ফজরের আগে সেহরির জন্য থামতে হবে এবং কখন মাগরিবে ইফতার করতে হবে। হিলাল আগেভাগে আঁচ করতে চাঁদ লক্ষ্য করুন, আর হিজরি তারিখ টুকে রাখুন যাতে মাসে আপনার অবস্থান সবসময় জানা থাকে। রোজার সময়ের সঙ্গে খাবার ও ঘুম সাজানো, কুরআন পড়া ও দান করার সহজ লক্ষ্য নির্ধারণ এবং মাস শুরুর আগে কাজ বা পড়াশোনা গুছিয়ে নেওয়াও সহায়ক। রমজান শেষ হলে একই সরঞ্জাম আপনাকে ঈদুল ফিতর পর্যন্ত কাউন্টডাউন করতে দেয়। নিচের সম্পর্কিত লিংকগুলো নামাজের সময়, চাঁদের দশা, হিজরি তারিখ ও ঈদ কাউন্টডাউন খোলে, যাতে আপনার প্রয়োজনীয় সবকিছু এক টোকা দূরে থাকে।' },
      ],
    },
    ms: {
      titles: {
      ...
      sections: [
        ...
        { h2: 'Cara menggunakan kira detik Ramadan',
          body: 'Buka halaman ini pada bila-bila masa untuk melihat berapa hari, jam dan minit lagi menjelang Ramadan; pemasa mengemas kini dirinya sendiri tanpa perlu muat semula. Benarkan akses lokasi supaya kira detik dan alat waktu solat yang berkaitan mencerminkan bandar anda sendiri, memberikan waktu sahur dan berbuka yang tepat sebaik bulan bermula. Gunakan jadual tahun untuk merancang lebih awal dan menyusun perjalanan, cuti atau pengajian di sekitar puasa, dan lihat panel bulan menjelang akhir Syaaban untuk mengikuti anak bulan yang menandakan permulaan. Tanda buku halaman ini dan kembali setiap hari untuk melihat angka menyusut, serta kongsikannya dengan keluarga yang bersedia menyambut bulan ini bersama anda.' },
        { h2: 'Apakah maksud tarikh Ramadan yang dijangka?',
          body: 'Tarikh Masihi yang dipaparkan di sini ialah tarikh dijangka hasil pengiraan — anggaran teliti tentang bila Ramadan berkemungkinan bermula, bukan pengumuman rasmi. Pada praktiknya bulan hanya bermula selepas pihak berkuasa agama di setiap negara mengesahkan rukyah anak bulan baharu pada akhir Syaaban, jadi hari pertama sebenar boleh jatuh sehari lebih awal atau lewat daripada anggaran. Anggap kira detik dan jadual tahun sebagai alat bantu perancangan yang membolehkan anda bersedia lebih awal sementara menunggu pengumuman di negara anda. Apabila harinya menghampiri, ikuti berita tempatan dan masjid anda supaya sahur dan puasa pertama anda bermula pada tarikh yang disahkan.' },
        { h2: 'Merancang untuk Ramadan',
          body: 'Sedikit persediaan menjadikan bulan ini lebih lancar. Ikuti waktu solat harian anda supaya tahu dengan tepat bila hendak berhenti untuk sahur sebelum Subuh dan bila berbuka pada waktu Maghrib. Perhatikan bulan untuk menjangka anak bulan, dan catat tarikh Hijrah supaya anda sentiasa tahu kedudukan anda dalam bulan ini. Ia juga membantu menyusun waktu makan dan tidur di sekitar waktu puasa, menetapkan matlamat mudah membaca al-Quran dan bersedekah, serta mengatur kerja atau pengajian sebelum bulan bermula. Apabila Ramadan berakhir, alat yang sama membolehkan anda mengira detik menuju Aidilfitri. Pautan berkaitan di bawah membuka waktu solat, fasa bulan, tarikh Hijrah dan kira detik Aidilfitri, supaya segala yang anda perlukan hanya sekali sentuh.' },
      ],
    },
  },
  ...
  'eid-fitr': {
    ar: {
      titles: {
        long:   'كم باقي على عيد الفطر {hy}؟ عد تنازلي لأول شوال',
        medium: 'كم باقي على عيد الفطر {hy}؟ | عد تنازلي',
        short:  'العد التنازلي لعيد الفطر {hy}',
      },
      desc: 'كم باقي على عيد الفطر {hy}؟ عد تنازلي مباشر لأول أيام شوال {hy} هـ بعد انقضاء رمضان، مع التاريخ الميلادي المتوقع وجدول السنوات القادمة.',
      sections: [
        { h2: 'متى يأتي عيد الفطر؟',
          body: 'يأتي عيد الفطر في أول يوم من شهر شوال، عقب انقضاء شهر رمضان وثبوت رؤية هلال شوال، فإن لم يُرَ الهلال أُكمل رمضان ثلاثين يومًا وكان العيد في اليوم التالي. ويُصلي المسلمون صلاة العيد ويُخرجون زكاة الفطر قبلها فرحًا بإتمام الصيام. ويبدأ المسلمون عيدهم بالتكبير من ليلته، ويتبادلون التهاني والزيارات وصلة الأرحام، ويُدخلون الفرح على الفقراء والأطفال بالكسوة والطعام، فيكون يومًا للشكر على إتمام عبادة الصيام والقيام طوال الشهر. ولأن الأشهر القمرية تتراوح بين 29 و30 يومًا، يتغير موعد العيد على التقويم الميلادي كل عام. ويعرض هذا العد التنازلي التاريخ الميلادي المتوقع لعيد الفطر {hy} هـ مع الأيام المتبقية حتى ذلك اليوم.' },
        { h2: 'لماذا يختلف موعد عيد الفطر بين الدول؟',
          body: 'تعتمد بعض الدول على رؤية هلال شوال بالعين المجردة، بينما تعتمد دول أخرى على الحساب الفلكي لتحديد نهاية رمضان وبداية العيد. وقد يُرى الهلال في منطقة قبل أخرى بيوم واحد، فيُعيد بلد قبل آخر بمقدار يوم. ويعتمد هذا العد التنازلي تاريخ تقويم أم القرى الحسابي مرجعًا تقديريًا، ويبقى التأكيد النهائي لما تعلنه الجهة الشرعية في بلدك، فلا غرابة في وجود فارق يوم بين بلد وآخر. والمقصد أن يجتمع الناس على الفرح بإتمام طاعتهم، فاتبع في عيدك ما تُقرره الجهة المعتمدة في بلدك.' },
        { h2: 'كيف يعمل هذا العد التنازلي؟',
          body: 'يعرض المؤقت المباشر الأيام والساعات والدقائق والثواني المتبقية حتى عيد الفطر المتوقع بتوقيت بلدك. ويُدرِج جدول السنوات مواعيد العيد للأعوام القادمة كي تخطط للاحتفال والزيارة والسفر مسبقًا، بينما تُظهر اللوحة القمرية طور القمر الحالي. وجميع التواريخ المعروضة تقديرية محسوبة فلكيًا، وقد تتقدم أو تتأخر يومًا واحدًا حسب ثبوت رؤية الهلال رسميًا.' },
        { h2: 'عيد الفطر والتقويم القمري',
          body: 'يقع عيد الفطر في أول شوال، الشهر العاشر من السنة الهجرية القمرية التي تبلغ نحو 354 يومًا، أي أقصر بنحو 11 يومًا من السنة الميلادية الشمسية. ولهذا يتقدم العيد نحو 11 يومًا كل عام ميلادي، فيمر عبر فصول السنة جميعها على مدى نحو 33 عامًا. ولذلك يتغير موعد العيد بالتقويم الميلادي من سنة لأخرى ويظل بحاجة إلى متابعة سنوية لضبطه بدقة. ويساعدك هذا العد على معرفة موعد العيد مبكرًا لتخطيط الإجازة والسفر وزيارة الأهل وتجهيز ما يلزم للاحتفال قبل حلول اليوم بوقتٍ كافٍ.' },
      ],
    },
    en: {
      titles: {
  ...
  'eid-adha': {
    ar: {
      titles: {
        long:   'كم باقي على عيد الأضحى {hy}؟ عد تنازلي ليوم النحر',
        medium: 'كم باقي على عيد الأضحى {hy}؟ | عد تنازلي',
        short:  'العد التنازلي لعيد الأضحى {hy}',
      },
      desc: 'كم باقي على عيد الأضحى {hy}؟ عد تنازلي مباشر ليوم النحر في 10 ذي الحجة {hy} هـ بعد يوم عرفة، مع التاريخ الميلادي المتوقع وجدول السنوات.',
      sections: [
        { h2: 'متى يأتي عيد الأضحى؟',
          body: 'يأتي عيد الأضحى في اليوم العاشر من شهر ذي الحجة، عقب يوم عرفة الذي هو التاسع منه، وفي موسم الحج الأكبر. ويُحدَد دخول ذي الحجة برؤية هلاله بعد انقضاء ذي القعدة، فإن لم يُرَ الهلال أُكمل ذو القعدة ثلاثين يومًا. ويُصلي المسلمون صلاة العيد ثم يذبحون الأضاحي إحياءً لسنة إبراهيم عليه السلام، وتمتد أيام العيد إلى الثالث عشر. ويُستحب توزيع لحم الأضحية على الفقراء والأقارب والجيران فيشمل الفرح المحتاجين، وتُسمى الأيام الثلاثة التالية للعيد أيام التشريق يُكثر فيها المسلمون من ذكر الله والتكبير. ويعرض هذا العد التنازلي التاريخ الميلادي المتوقع لعيد الأضحى {hy} هـ مع الأيام المتبقية.' },
        { h2: 'لماذا يختلف موعد عيد الأضحى بين الدول؟',
          body: 'تعتمد بعض الدول على رؤية هلال ذي الحجة بالعين المجردة، بينما تعتمد دول أخرى على الحساب الفلكي لتحديد بدايته. وقد يُرى الهلال في منطقة قبل أخرى بيوم واحد، فيختلف يوم عرفة والعيد رسميًا بين بلد وآخر بمقدار يوم، مع أن وقفة عرفة مرتبطة بموسم الحج في مكة. ويعتمد هذا العد التنازلي تاريخ تقويم أم القرى الحسابي مرجعًا تقديريًا، ويبقى التأكيد لما تعلنه الجهة الشرعية في بلدك. ويبقى يوم عرفة لأهل الموقف هو التاسع من ذي الحجة في مكة، ويصومه المسلمون في بلدانهم وفق إعلان جهاتهم.' },
        { h2: 'كيف يعمل هذا العد التنازلي؟',
          body: 'يعرض المؤقت المباشر الأيام والساعات والدقائق والثواني المتبقية حتى عيد الأضحى المتوقع بتوقيت بلدك، وقبله بيوم تكون وقفة عرفة. ويُدرِج جدول السنوات مواعيد العيد للأعوام القادمة كي تخطط للأضحية والحج والسفر مسبقًا، بينما تُظهر اللوحة القمرية طور القمر الحالي. وجميع التواريخ تقديرية محسوبة فلكيًا، وقد تتقدم أو تتأخر يومًا حسب ثبوت الرؤية رسميًا.' },
        { h2: 'عيد الأضحى والتقويم القمري',
          body: 'يقع عيد الأضحى في العاشر من ذي الحجة، آخر شهور السنة الهجرية القمرية التي تبلغ نحو 354 يومًا، أي أقصر بنحو 11 يومًا من السنة الميلادية الشمسية. ولهذا يتقدم العيد ووقفة عرفة نحو 11 يومًا كل عام ميلادي، فيمران عبر فصول السنة جميعها على مدى نحو 33 عامًا. ولذلك يختلف موعد العيد بالتقويم الميلادي من سنة لأخرى ويحتاج إلى متابعة سنوية. ويساعدك هذا العد على معرفة موعد العيد ووقفة عرفة مبكرًا لتخطيط الأضحية والحج والإجازة والسفر وتجهيز ما يلزم قبل حلول الموسم بوقتٍ كافٍ.' },
      ],
    },
    en: {
      titles: {
