...
// ---- 7. cache-busters ----
A(html.includes('azkar-data.js?v=43'), 'index.html azkar-data.js?v=43');
A(html.includes('app.js?v=842'), 'index.html app.js?v=842 (unchanged)');
A(fs.readFileSync(ROOT + '/sw.js', 'utf8').includes("CACHE_VERSION = 'v541'"), "sw.js CACHE_VERSION 'v541'");
