...
console.log('\n================ 8. Cache-busters bumped (azkar-data.js?v=39 + sw v536) ================');
ok(/js\/azkar-data\.js\?v=39\b/.test(htmlSrc), 'index.html loads js/azkar-data.js?v=39');
ok(!/js\/azkar-data\.js\?v=38\b/.test(htmlSrc), 'no stale ?v=38 azkar-data reference in index.html');
ok(/CACHE_VERSION\s*=\s*'v536'/.test(swSrc), "sw.js CACHE_VERSION = 'v536'");
