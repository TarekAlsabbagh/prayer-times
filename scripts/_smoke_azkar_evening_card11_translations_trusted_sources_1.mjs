...
console.log('\n================ 11. Cache-busters bumped (azkar-data.js?v=43 + sw v541; app.js?v=842 + style.css?v=500 STABLE) ================');
ok(/js\/azkar-data\.js\?v=43\b/.test(htmlSrc), 'index.html loads js/azkar-data.js?v=43');
ok(!/js\/azkar-data\.js\?v=42\b/.test(htmlSrc), 'no stale ?v=42 azkar-data reference in index.html');
ok(/CACHE_VERSION\s*=\s*'v541'/.test(swSrc), "sw.js CACHE_VERSION = 'v541'");
