...
console.log('\n================ 7. Evening 001-022 translated; 023+ untranslated; morning + prayer intact; morning-012 UNCHANGED ================');
for (let n = 1; n <= 22; n++) {
...
console.log('\n================ 9. Cache-busters bumped (azkar-data.js?v=54 + sw v552; app.js?v=842 + style.css?v=500 STABLE) ================');
