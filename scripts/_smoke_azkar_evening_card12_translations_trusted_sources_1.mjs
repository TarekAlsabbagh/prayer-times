...
console.log('\n================ 7. Evening 001-016 translated; 017+ untranslated; morning + prayer intact; morning-012 UNCHANGED ================');
for (let n = 1; n <= 16; n++) {
...
console.log('\n================ 9. Cache-busters bumped (azkar-data.js?v=48 + sw v546; app.js?v=842 + style.css?v=500 STABLE) ================');
