...
console.log('\n================ 7. Evening 001-017 translated; 018+ untranslated; morning + prayer intact; morning-012 UNCHANGED ================');
for (let n = 1; n <= 17; n++) {
...
console.log('\n================ 9. Cache-busters bumped (azkar-data.js?v=49 + sw v547; app.js?v=842 + style.css?v=500 STABLE) ================');
ok(/js\/azkar-data\.js\?v=49\b/.test(htmlSrc), 'index.html loads js/azkar-data.js?v=49');
ok(!/js\/azkar-data\.js\?v=48\b/.test(htmlSrc), 'no stale ?v=43 azkar-data reference in index.html');
