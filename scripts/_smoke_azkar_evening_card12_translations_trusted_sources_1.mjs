...
console.log('\n================ 7. Evening 001-021 translated; 022+ untranslated; morning + prayer intact; morning-012 UNCHANGED ================');
for (let n = 1; n <= 21; n++) {
...
console.log('\n================ 9. Cache-busters bumped (azkar-data.js?v=53 + sw v551; app.js?v=842 + style.css?v=500 STABLE) ================');
ok(/js\/azkar-data\.js\?v=53\b/.test(htmlSrc), 'index.html loads js/azkar-data.js?v=53');
ok(!/js\/azkar-data\.js\?v=52\b/.test(htmlSrc), 'no stale ?v=43 azkar-data reference in index.html');
