...
console.log('\n================ 7. Evening 001-012 translated; 013+ untranslated; morning + prayer intact; morning-012 UNCHANGED ================');
for (let n = 1; n <= 12; n++) {
...
console.log('\n================ 9. Cache-busters bumped (azkar-data.js?v=44 + sw v542; app.js?v=842 + style.css?v=500 STABLE) ================');
ok(/js\/azkar-data\.js\?v=44\b/.test(htmlSrc), 'index.html loads js/azkar-data.js?v=44');
ok(!/js\/azkar-data\.js\?v=43\b/.test(htmlSrc), 'no stale ?v=43 azkar-data reference in index.html');
