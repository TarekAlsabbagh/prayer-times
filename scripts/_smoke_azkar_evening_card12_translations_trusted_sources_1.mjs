...
console.log('\n================ 7. Evening 001-023 translated; 024+ untranslated; morning + prayer intact; morning-012 UNCHANGED ================');
for (let n = 1; n <= 23; n++) {
...
console.log('\n================ 9. Cache-busters bumped (azkar-data.js?v=55 + sw v553; app.js?v=842 + style.css?v=500 STABLE) ================');
