...
console.log('\n================ 11. Evening 001-019 translated; 020+ untranslated; prayer intact ================');
for (let n = 1; n <= 19; n++) {
...
console.log('\n================ 19. Cache-busters bumped (azkar-data.js?v=51 + sw v549; app.js?v=842 + style.css?v=500 STABLE) ================');
ok(/js\/azkar-data\.js\?v=51\b/.test(htmlSrc), 'index.html loads js/azkar-data.js?v=51');
ok(!/js\/azkar-data\.js\?v=50\b/.test(htmlSrc), 'no stale ?v=44 azkar-data reference in index.html');
