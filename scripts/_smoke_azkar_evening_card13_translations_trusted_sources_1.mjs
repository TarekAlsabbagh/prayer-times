...
console.log('\n================ 11. Evening 001-014 translated; 015+ untranslated; prayer intact ================');
for (let n = 1; n <= 14; n++) {
...
console.log('\n================ 14. Cache-busters bumped (azkar-data.js?v=46 + sw v544; app.js?v=842 + style.css?v=500 STABLE) ================');
ok(/js\/azkar-data\.js\?v=46\b/.test(htmlSrc), 'index.html loads js/azkar-data.js?v=46');
ok(!/js\/azkar-data\.js\?v=45\b/.test(htmlSrc), 'no stale ?v=44 azkar-data reference in index.html');
