...
console.log('\n================ 11. Evening 001-013 translated; 014+ untranslated; prayer intact ================');
for (let n = 1; n <= 13; n++) {
...
console.log('\n================ 13. Cache-busters bumped (azkar-data.js?v=45 + sw v543; app.js?v=842 + style.css?v=500 STABLE) ================');
ok(/js\/azkar-data\.js\?v=45\b/.test(htmlSrc), 'index.html loads js/azkar-data.js?v=45');
ok(!/js\/azkar-data\.js\?v=44\b/.test(htmlSrc), 'no stale ?v=44 azkar-data reference in index.html');
