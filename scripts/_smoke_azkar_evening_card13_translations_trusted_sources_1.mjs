...
console.log('\n================ 11. Evening 001-020 translated; 021+ untranslated; prayer intact ================');
for (let n = 1; n <= 20; n++) {
...
console.log('\n================ 20. Cache-busters bumped (azkar-data.js?v=52 + sw v550; app.js?v=842 + style.css?v=500 STABLE) ================');
ok(/js\/azkar-data\.js\?v=52\b/.test(htmlSrc), 'index.html loads js/azkar-data.js?v=52');
ok(!/js\/azkar-data\.js\?v=51\b/.test(htmlSrc), 'no stale ?v=44 azkar-data reference in index.html');
