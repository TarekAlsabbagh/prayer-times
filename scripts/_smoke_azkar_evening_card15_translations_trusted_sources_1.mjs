...
console.log('\n================ 9. Evening 001-016 translated; 017+ untranslated; prayer intact ================');
for (let n = 1; n <= 16; n++) {
...
console.log('\n================ 11. Cache-busters bumped (azkar-data.js?v=48 + sw v546; app.js?v=842 + style.css?v=500 STABLE) ================');
ok(/js\/azkar-data\.js\?v=48\b/.test(htmlSrc), 'index.html loads js/azkar-data.js?v=48');
ok(!/js\/azkar-data\.js\?v=47\b/.test(htmlSrc), 'no stale ?v=46 azkar-data reference in index.html');
