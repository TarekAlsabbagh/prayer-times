...
console.log('\n================ 9. Evening 001-015 translated; 016+ untranslated; prayer intact ================');
for (let n = 1; n <= 15; n++) {
...
console.log('\n================ 11. Cache-busters bumped (azkar-data.js?v=47 + sw v545; app.js?v=842 + style.css?v=500 STABLE) ================');
ok(/js\/azkar-data\.js\?v=47\b/.test(htmlSrc), 'index.html loads js/azkar-data.js?v=47');
ok(!/js\/azkar-data\.js\?v=46\b/.test(htmlSrc), 'no stale ?v=46 azkar-data reference in index.html');
