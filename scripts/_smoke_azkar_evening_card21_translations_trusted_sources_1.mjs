...
console.log('\n================ 10. Per-region counts — evening 21, morning 25, prayer 0, ar 0 ================');
...
console.log('\n================ 11. Evening 001-021 translated; 022+ untranslated; morning/prayer intact ================');
for (let n = 1; n <= 21; n++) {
...
console.log('\n================ 13. Cache-busters bumped (azkar-data.js?v=53 + sw v551; app.js?v=842 + style.css?v=500 STABLE) ================');
