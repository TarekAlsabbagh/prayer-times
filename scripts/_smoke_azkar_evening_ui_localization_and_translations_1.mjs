...
const _MORN_EXPECT = { en: 13, ur: 13, tr: 13, bn: 13, es: 13, id: 13, de: 13, fr: 13, ms: 13 }; // Card 13 complete: uniform 13
...
console.log('\n================ 9. Cache-busters ================');
ok(/js\/azkar-data\.js\?v=21/.test(htmlSrc), 'index.html azkar-data.js?v=21 (bumped by the Card 09 ticket)');
ok(/js\/app\.js\?v=836/.test(htmlSrc), 'index.html app.js?v=836');
ok(/CACHE_VERSION = 'v517'/.test(swSrc), "sw.js CACHE_VERSION 'v517' (bumped by the Card 09 ticket)");
