...
const _MORN_EXPECT = { en: 15, ur: 15, tr: 15, bn: 15, es: 15, id: 15, de: 15, fr: 15, ms: 15 }; // Card 15 complete: uniform 15
...
console.log('\n================ 9. Cache-busters ================');
ok(/js\/azkar-data\.js\?v=23/.test(htmlSrc), 'index.html azkar-data.js?v=23 (bumped by the Card 09 ticket)');
ok(/js\/app\.js\?v=836/.test(htmlSrc), 'index.html app.js?v=836');
ok(/CACHE_VERSION = 'v519'/.test(swSrc), "sw.js CACHE_VERSION 'v519' (bumped by the Card 09 ticket)");
