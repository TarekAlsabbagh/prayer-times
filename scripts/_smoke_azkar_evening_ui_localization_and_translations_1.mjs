...
const _MORN_EXPECT = { en: 16, ur: 16, tr: 16, bn: 16, es: 16, id: 16, de: 16, fr: 16, ms: 16 }; // Card 16 complete: uniform 16
...
console.log('\n================ 9. Cache-busters ================');
ok(/js\/azkar-data\.js\?v=24/.test(htmlSrc), 'index.html azkar-data.js?v=24 (bumped by the Card 09 ticket)');
ok(/js\/app\.js\?v=836/.test(htmlSrc), 'index.html app.js?v=836');
ok(/CACHE_VERSION = 'v520'/.test(swSrc), "sw.js CACHE_VERSION 'v519' (bumped by the Card 09 ticket)");
