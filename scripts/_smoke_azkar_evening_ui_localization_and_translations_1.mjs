...
const _MORN_EXPECT = { en: 17, ur: 17, tr: 17, bn: 17, es: 17, id: 17, de: 17, fr: 17, ms: 17 }; // Card 17 complete: uniform 17
...
console.log('\n================ 9. Cache-busters ================');
ok(/js\/azkar-data\.js\?v=25/.test(htmlSrc), 'index.html azkar-data.js?v=25 (bumped by the Card 09 ticket)');
ok(/js\/app\.js\?v=836/.test(htmlSrc), 'index.html app.js?v=836');
ok(/CACHE_VERSION = 'v521'/.test(swSrc), "sw.js CACHE_VERSION 'v519' (bumped by the Card 09 ticket)");
