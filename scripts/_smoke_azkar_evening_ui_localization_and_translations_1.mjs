...
const _MORN_EXPECT = { en: 14, ur: 14, tr: 14, bn: 14, es: 14, id: 14, de: 14, fr: 14, ms: 14 }; // Card 14 complete: uniform 14
...
console.log('\n================ 9. Cache-busters ================');
ok(/js\/azkar-data\.js\?v=22/.test(htmlSrc), 'index.html azkar-data.js?v=22 (bumped by the Card 09 ticket)');
ok(/js\/app\.js\?v=836/.test(htmlSrc), 'index.html app.js?v=836');
ok(/CACHE_VERSION = 'v518'/.test(swSrc), "sw.js CACHE_VERSION 'v518' (bumped by the Card 09 ticket)");
