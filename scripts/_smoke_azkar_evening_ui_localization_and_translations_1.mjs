...
const _MORN_EXPECT = { en: 6, ur: 6, tr: 6, bn: 6, es: 6, id: 6, de: 6, fr: 6, ms: 6 }; // PENDING ticket filled de/fr/ms
...
console.log('\n================ 9. Cache-busters ================');
ok(/js\/azkar-data\.js\?v=14/.test(htmlSrc), 'index.html azkar-data.js?v=14 (bumped by the PENDING ticket)');
ok(/js\/app\.js\?v=836/.test(htmlSrc), 'index.html app.js?v=836');
ok(/CACHE_VERSION = 'v510'/.test(swSrc), "sw.js CACHE_VERSION 'v510' (bumped by the PENDING ticket)");
