...
const _MORN_EXPECT = { en: 22, ur: 22, tr: 22, bn: 22, es: 22, id: 22, de: 22, fr: 22, ms: 22 }; // Card 22 complete: uniform 22
...
console.log('\n================ 9. Cache-busters ================');
ok(/js\/azkar-data\.js\?v=30/.test(htmlSrc), 'index.html azkar-data.js?v=30 (bumped by the Card 09 ticket)');
ok(/js\/app\.js\?v=836/.test(htmlSrc), 'index.html app.js?v=836');
ok(/CACHE_VERSION = 'v526'/.test(swSrc), "sw.js CACHE_VERSION 'v519' (bumped by the Card 09 ticket)");
