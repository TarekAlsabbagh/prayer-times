...
const _MORN_EXPECT = { en: 23, ur: 23, tr: 23, bn: 23, es: 23, id: 23, de: 23, fr: 23, ms: 23 }; // Card 23 complete: uniform 23
...
console.log('\n================ 9. Cache-busters ================');
ok(/js\/azkar-data\.js\?v=31/.test(htmlSrc), 'index.html azkar-data.js?v=31 (bumped by the Card 09 ticket)');
ok(/js\/app\.js\?v=836/.test(htmlSrc), 'index.html app.js?v=836');
ok(/CACHE_VERSION = 'v527'/.test(swSrc), "sw.js CACHE_VERSION 'v519' (bumped by the Card 09 ticket)");
