...
const _MORN_EXPECT = { en: 8, ur: 8, tr: 8, bn: 8, es: 8, id: 8, de: 8, fr: 8, ms: 8 }; // Card 08 complete: uniform 8
...
console.log('\n================ 9. Cache-busters ================');
ok(/js\/azkar-data\.js\?v=16/.test(htmlSrc), 'index.html azkar-data.js?v=16 (bumped by the Card 08 ticket)');
ok(/js\/app\.js\?v=836/.test(htmlSrc), 'index.html app.js?v=836');
ok(/CACHE_VERSION = 'v512'/.test(swSrc), "sw.js CACHE_VERSION 'v512' (bumped by the Card 08 ticket)");
