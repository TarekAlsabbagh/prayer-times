...
const _MORN_EXPECT = { en: 24, ur: 24, tr: 24, bn: 24, es: 24, id: 24, de: 24, fr: 24, ms: 24 }; // Card 24 complete: uniform 24
...
console.log('\n================ 9. Cache-busters ================');
ok(/js\/azkar-data\.js\?v=32/.test(htmlSrc), 'index.html azkar-data.js?v=32 (bumped by the Card 09 ticket)');
ok(/js\/app\.js\?v=836/.test(htmlSrc), 'index.html app.js?v=836');
ok(/CACHE_VERSION = 'v528'/.test(swSrc), "sw.js CACHE_VERSION 'v519' (bumped by the Card 09 ticket)");
