...
const _MORN_EXPECT = { en: 7, ur: 7, tr: 7, bn: 7, es: 7, id: 7, de: 7, fr: 7, ms: 7 }; // Card 07 → uniform 7
...
console.log('\n================ 9. Cache-busters ================');
ok(/js\/azkar-data\.js\?v=15/.test(htmlSrc), 'index.html azkar-data.js?v=15 (bumped by the Card 07 ticket)');
ok(/js\/app\.js\?v=836/.test(htmlSrc), 'index.html app.js?v=836');
ok(/CACHE_VERSION = 'v511'/.test(swSrc), "sw.js CACHE_VERSION 'v511' (bumped by the Card 07 ticket)");
