...
const _MORN_EXPECT = { en: 18, ur: 18, tr: 18, bn: 18, es: 18, id: 18, de: 18, fr: 18, ms: 18 }; // Card 18 complete: uniform 18
...
console.log('\n================ 9. Cache-busters ================');
ok(/js\/azkar-data\.js\?v=26/.test(htmlSrc), 'index.html azkar-data.js?v=26 (bumped by the Card 09 ticket)');
ok(/js\/app\.js\?v=836/.test(htmlSrc), 'index.html app.js?v=836');
ok(/CACHE_VERSION = 'v522'/.test(swSrc), "sw.js CACHE_VERSION 'v519' (bumped by the Card 09 ticket)");
