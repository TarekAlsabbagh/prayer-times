...
for (const l of ALL9) ok((mr.match(new RegExp('translation_' + l + ':', 'g')) || []).length === 12, `morning region translation_${l}: EXACTLY 12`);
...
console.log('\n================ 9. Cache-busters ================');
ok(/js\/azkar-data\.js\?v=20/.test(htmlSrc), 'index.html azkar-data.js?v=20 (later card bumped it)');
...
ok(/CACHE_VERSION = 'v516'/.test(swSrc), "sw.js CACHE_VERSION 'v516'");
