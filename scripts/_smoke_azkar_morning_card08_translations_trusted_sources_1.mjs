...
for (const l of ALL9) ok((mr.match(new RegExp('translation_' + l + ':', 'g')) || []).length === 13, `morning region translation_${l}: EXACTLY 13`);
...
console.log('\n================ 9. Cache-busters ================');
ok(/js\/azkar-data\.js\?v=21/.test(htmlSrc), 'index.html azkar-data.js?v=21 (later card bumped it)');
...
ok(/CACHE_VERSION = 'v517'/.test(swSrc), "sw.js CACHE_VERSION 'v517'");
