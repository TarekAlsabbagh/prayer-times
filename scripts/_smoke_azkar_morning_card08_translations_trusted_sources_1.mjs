...
for (const l of ALL9) ok((mr.match(new RegExp('translation_' + l + ':', 'g')) || []).length === 17, `morning region translation_${l}: EXACTLY 17`);
...
console.log('\n================ 9. Cache-busters ================');
ok(/js\/azkar-data\.js\?v=25/.test(htmlSrc), 'index.html azkar-data.js?v=25 (later card bumped it)');
...
ok(/CACHE_VERSION = 'v521'/.test(swSrc), "sw.js CACHE_VERSION 'v519'");
