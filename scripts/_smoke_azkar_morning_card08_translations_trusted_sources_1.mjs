...
for (const l of ALL9) ok((mr.match(new RegExp('translation_' + l + ':', 'g')) || []).length === 8, `morning region translation_${l}: EXACTLY 8`);
...
console.log('\n================ 9. Cache-busters ================');
ok(/js\/azkar-data\.js\?v=16/.test(htmlSrc), 'index.html azkar-data.js?v=16 (Card 08 data added)');
...
ok(/CACHE_VERSION = 'v512'/.test(swSrc), "sw.js CACHE_VERSION 'v512'");
