...
for (const l of ALL9) ok((mr.match(new RegExp('translation_' + l + ':', 'g')) || []).length === 9, `morning region translation_${l}: EXACTLY 9`);
...
console.log('\n================ 9. Cache-busters ================');
ok(/js\/azkar-data\.js\?v=17/.test(htmlSrc), 'index.html azkar-data.js?v=17 (later card bumped it)');
