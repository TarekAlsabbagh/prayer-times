...
const _EXP9 = { en: 25, ur: 25, tr: 25, bn: 25, es: 25, id: 25, de: 25, fr: 25, ms: 25 }; // Card 25 complete: uniform 25
...
for (const l of ALL9) ok((evRegion.match(new RegExp('translation_' + l + ':', 'g')) || []).length === 16, `evening region translation_${l} still EXACTLY 16`);
...
console.log('\n================ 7. Cache-busters ================');
ok(/js\/azkar-data\.js\?v=36[4-9]|js\/azkar-data\.js\?v=[2-9]\d/.test(htmlSrc), 'index.html azkar-data.js?v >= 14 (later tickets bump it)');
