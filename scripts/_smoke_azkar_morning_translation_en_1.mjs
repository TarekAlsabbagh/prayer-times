...
const _MORN_EXPECT = { en: 20, ur: 20, tr: 20, bn: 20, es: 20, id: 20, de: 20, fr: 20, ms: 20 };
...
ok(/js\/azkar-data\.js\?v=28/.test(htmlSrc), 'index.html azkar-data.js?v=28 (data changed: Card 09 translations added)');
ok(/js\/app\.js\?v=836/.test(htmlSrc), 'index.html app.js?v=836 (app.js untouched — generic renderer)');
ok(/CACHE_VERSION = 'v524'/.test(swSrc), "sw.js CACHE_VERSION 'v519'");
