...
const _MORN_EXPECT = { en: 22, ur: 22, tr: 22, bn: 22, es: 22, id: 22, de: 22, fr: 22, ms: 22 };
...
ok(/js\/azkar-data\.js\?v=30/.test(htmlSrc), 'index.html azkar-data.js?v=30 (data changed: Card 09 translations added)');
