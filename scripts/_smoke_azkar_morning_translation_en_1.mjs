...
ok(/js\/azkar-data\.js\?v=53/.test(htmlSrc), 'index.html azkar-data.js?v=53 (data changed: Card 09 translations added)');
ok(/js\/app\.js\?v=842/.test(htmlSrc), 'index.html app.js?v=842 (app.js untouched — generic renderer)');
ok(/CACHE_VERSION = 'v551'/.test(swSrc), "sw.js CACHE_VERSION 'v551'");
