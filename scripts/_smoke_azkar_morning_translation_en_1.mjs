...
const _MORN_EXPECT = { en: 21, ur: 21, tr: 21, bn: 21, es: 21, id: 21, de: 21, fr: 21, ms: 21 };
...
ok(/js\/azkar-data\.js\?v=29/.test(htmlSrc), 'index.html azkar-data.js?v=29 (data changed: Card 09 translations added)');
