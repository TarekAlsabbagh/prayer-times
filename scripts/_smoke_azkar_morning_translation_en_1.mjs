...
const _MORN_EXPECT = { en: 13, ur: 13, tr: 13, bn: 13, es: 13, id: 13, de: 13, fr: 13, ms: 13 };
...
ok(/js\/azkar-data\.js\?v=21/.test(htmlSrc), 'index.html azkar-data.js?v=21 (data changed: Card 09 translations added)');
