...
const _MORN_EXPECT = { en: 18, ur: 18, tr: 18, bn: 18, es: 18, id: 18, de: 18, fr: 18, ms: 18 };
...
ok(/js\/azkar-data\.js\?v=26/.test(htmlSrc), 'index.html azkar-data.js?v=26 (data changed: Card 09 translations added)');
