...
const _MORN_EXPECT = { en: 14, ur: 14, tr: 14, bn: 14, es: 14, id: 14, de: 14, fr: 14, ms: 14 };
...
ok(/js\/azkar-data\.js\?v=22/.test(htmlSrc), 'index.html azkar-data.js?v=22 (data changed: Card 09 translations added)');
