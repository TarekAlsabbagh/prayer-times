...
const _MORN_EXPECT = { en: 8, ur: 8, tr: 8, bn: 8, es: 8, id: 8, de: 8, fr: 8, ms: 8 };
...
ok(/js\/azkar-data\.js\?v=16/.test(htmlSrc), 'index.html azkar-data.js?v=16 (data changed: Card 08 en translation added)');
