...
ok(/js\/azkar-data\.js\?v=55/.test(htmlSrc), 'index.html azkar-data.js?v=55 (data changed: Card 09 translations added)');
ok(/js\/app\.js\?v=843/.test(htmlSrc), 'index.html app.js?v=843 (app.js untouched — generic renderer)');
