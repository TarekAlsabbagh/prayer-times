...
const _MORN_EXPECT = { en: 24, ur: 24, tr: 24, bn: 24, es: 24, id: 24, de: 24, fr: 24, ms: 24 };
...
ok(/js\/azkar-data\.js\?v=32/.test(htmlSrc), 'index.html azkar-data.js?v=32 (data changed: Card 09 translations added)');
ok(/js\/app\.js\?v=836/.test(htmlSrc), 'index.html app.js?v=836 (app.js untouched — generic renderer)');
ok(/CACHE_VERSION = 'v528'/.test(swSrc), "sw.js CACHE_VERSION 'v519'");
