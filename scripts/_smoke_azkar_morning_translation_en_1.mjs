...
const _MORN_EXPECT = { en: 17, ur: 17, tr: 17, bn: 17, es: 17, id: 17, de: 17, fr: 17, ms: 17 };
...
ok(/js\/azkar-data\.js\?v=25/.test(htmlSrc), 'index.html azkar-data.js?v=25 (data changed: Card 09 translations added)');
