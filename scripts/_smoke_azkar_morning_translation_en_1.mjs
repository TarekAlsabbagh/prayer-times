...
const _MORN_EXPECT = { en: 12, ur: 12, tr: 12, bn: 12, es: 12, id: 12, de: 12, fr: 12, ms: 12 };
...
ok(/js\/azkar-data\.js\?v=20/.test(htmlSrc), 'index.html azkar-data.js?v=20 (data changed: Card 09 translations added)');
