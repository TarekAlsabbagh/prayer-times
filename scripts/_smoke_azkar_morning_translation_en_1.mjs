...
const _MORN_EXPECT = { en: 19, ur: 19, tr: 19, bn: 19, es: 19, id: 19, de: 19, fr: 19, ms: 19 };
...
ok(/js\/azkar-data\.js\?v=27/.test(htmlSrc), 'index.html azkar-data.js?v=27 (data changed: Card 09 translations added)');
ok(/js\/app\.js\?v=836/.test(htmlSrc), 'index.html app.js?v=836 (app.js untouched — generic renderer)');
ok(/CACHE_VERSION = 'v523'/.test(swSrc), "sw.js CACHE_VERSION 'v519'");
