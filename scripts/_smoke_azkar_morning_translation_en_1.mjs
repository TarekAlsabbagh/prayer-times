...
const _MORN_EXPECT = { en: 11, ur: 11, tr: 11, bn: 11, es: 11, id: 11, de: 11, fr: 11, ms: 11 };
...
ok(/js\/azkar-data\.js\?v=19/.test(htmlSrc), 'index.html azkar-data.js?v=19 (data changed: Card 09 translations added)');
