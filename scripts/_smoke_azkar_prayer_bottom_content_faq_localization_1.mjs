...
A(html.includes('azkar-data.js?v=44'), 'index.html azkar-data.js?v=44');
A(html.includes('app.js?v=842') && !html.includes('app.js?v=837'), 'index.html app.js?v=842 (bumped, no stale 837)');
A(fs.readFileSync(ROOT + '/sw.js', 'utf8').includes("CACHE_VERSION = 'v542'"), "sw.js CACHE_VERSION 'v542'");
