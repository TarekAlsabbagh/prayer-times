...
ok(/_androidCompassStabilize\(h\);/.test(A), 'AOS reading feeds the SAME jitter stabilizer');
...
ok(/_androidCompassStabilize\(heading\);/.test(H), 'V2 fallback still feeds the jitter stabilizer');
...
ok(/css\/style\.css\?v=492/.test(htmlSrc), 'index.html css/style.css?v=492 (CSS unchanged this ticket)');
