...
ok(/_androidCompassStabilize\(heading\);/.test(appSrc), 'Android branch routes through _androidCompassStabilize');
...
ok(!/offset/i.test(codeOnly), 'NO "offset" token in the compass CODE (comments stripped)');
