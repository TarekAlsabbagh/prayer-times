...
ok(/_androidAlphaToHeading\(e\.alpha\);[\s\S]{0,240}?_androidCompassStabilize\(heading\)/.test(appSrc), 'Android branch still routes through the jitter stabilizer (raw heading; manual calibration removed)');
