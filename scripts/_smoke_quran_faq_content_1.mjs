...
ok(qCount === 7, 'exactly 7 FAQ questions in the data array (' + qCount + ')');
...
['كم عدد آيات سورة', 'ما رقم سورة', 'في أي جزء تقع', 'من أي صفحة إلى أي صفحة', 'مكية أم مدنية', 'لماذا سميت سورة', 'كيف أنتقل إلى آية'].forEach(q =>
