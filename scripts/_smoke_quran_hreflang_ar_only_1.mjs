...
// so the slice anchors on that branch instead of the old hardcoded staticPages['/quran/surah/21'] key.
...
// …and the entry opts out of the hreflang alternates block: /{lang}/quran/surah/:n does not exist.
