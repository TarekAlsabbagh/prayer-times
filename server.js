...
// Phase D1: shorter homepage descs — trim to ~125–148 chars per language
    ...
    if (m) {
        ...
        // Phase Q-A (2026-05-03): extended Title per language to ~58 chars sweet spot.
        ...
        // Phase Q-A (2026-05-03): extended Meta from ~95 chars (failing SEOptimer's
...
function serveHtmlWithSeo(htmlBuf, urlPath, res, acceptEnc, qs) {
    ...
    if (seo.moonCity) {
        ...
        if (_isMoonHubPageSsr && MoonCalc && typeof MoonCalc.getPhaseName === 'function') {
            try {
                ...
                // Phase M6 (2026-05-03): retired the natural-language relative-day
                ...
                // Phase M6 (2026-05-03): legend explains +/- semantics shown in cells.
    ...
    // ── Phase Q-A (2026-05-03) — scope fix v2: moved OUT of seo.moonCity gate ──
        ...
        if (seo.qiblaRef && seo.qiblaRef.slug && typeof seo.qiblaRef.lat === 'number') {
            try {
                ...
                // Phase Q-A2 (2026-05-03): extra paragraph appended to Section 4
