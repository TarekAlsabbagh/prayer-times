...
function buildSeoForPath(urlPath) {
    ...
    const staticPages = {
        ...
        '/moon-today': {
            title: {
                ar: 'حالة القمر اليوم - طور القمر ونسبة الإضاءة والعمر',
                en: 'Moon State Today - Phase, Illumination, Age & Distance',
                fr: 'État de la Lune aujourd\u2019hui - Phase, Illumination, Âge et Distance',
                tr: 'Ayın Bugünkü Durumu - Evre, Aydınlanma, Yaş ve Mesafe',
                ur: 'آج چاند کی حالت - طور، روشنی، عمر اور فاصلہ',
                de: 'Mondzustand heute - Phase, Beleuchtung, Alter und Entfernung',
    ...
    if (seo.moonFaq) {
        ...
        const MOON_FAQ_I18N = {
            ar: [
                ...
                { q: 'ما خسوف القمر ولماذا يحدث؟',
                  a: 'خسوف القمر يحدث عندما تقع الأرض بين الشمس والقمر فيدخل القمر ظلّ الأرض. يحدث فقط في طور البدر، ويتراوح بين خسوف جزئيّ وخسوف كلّيّ. في الخسوف الكلّيّ يظهر القمر بلون أحمر داكن يُعرف بـ«القمر الدمويّ» بسبب تشتّت ضوء الشمس في غلاف الأرض الجوّيّ.' },
                { q: 'لماذا نرى دائمًا نفس وجه القمر؟',
                  a: 'يُعرف هذا بـ«القفل المدّيّ» (tidal locking): دورة القمر حول نفسه (27.3 يوم) تساوي دورته حول الأرض. لذلك يظلّ أحد وجهيه مواجهاً للأرض دائماً، والوجه الآخر يُعرف بـ«الجانب البعيد» وقد صُوِّر لأوّل مرّة عام 1959 بمركبة لونا 3 السوفيتيّة.' },
                { q: 'كيف يؤثّر القمر على المدّ والجزر؟',
                  a: 'جاذبيّة القمر تسحب مياه المحيطات فتنتفخ تجاه القمر (مدّ) وفي الجانب المقابل أيضاً بسبب القوّة الطاردة المركزيّة. بين النتوءين يحدث الجزر. يحدث مدّان وجزران في اليوم الواحد تقريباً. عند اجتماع القمر مع الشمس (محاق أو بدر) يصل المدّ لأقصاه ويُسمّى «مدّ الربيع».' },
                { q: 'هل تؤثّر أطوار القمر على النوم والمزاج؟',
                  a: 'دراسات علميّة محدودة أظهرت أنّ بعض الأشخاص يعانون من نوم أقلّ جودة بنحو 20-30 دقيقة في ليالي البدر، وقد يعود ذلك إلى زيادة الضوء في السماء. لكن التأثير طفيف ويختلف من شخص لآخر، ولا يوجد دليل علميّ قاطع على تأثير القمر على المزاج أو السلوك بشكل عامّ.' },
                { q: 'لماذا يبدو القمر أحيانًا أصفر أو أحمر؟',
                  a: 'عندما يكون القمر قريباً من الأفق، ضوؤه يمرّ بطبقة أسمك من الغلاف الجوّيّ، فيتشتّت الضوء الأزرق ويبقى الأحمر والأصفر. نفس الظاهرة تُسبّب شروقاً وغروباً ملوّنَين للشمس. كلّما ارتفع القمر في السماء عاد لونه إلى الأبيض الفضّيّ.' },
                { q: 'ما معنى «القمر الأزرق» و«القمر العملاق»؟',
                  a: '«القمر الأزرق» (Blue Moon): بدر ثانٍ في الشهر الميلاديّ نفسه، يحدث تقريباً كلّ 2.7 سنة (ليس أزرق اللون فعلاً). «القمر العملاق» (Supermoon): بدر يتزامن مع أقرب نقطة للقمر من الأرض (الحضيض)، فيظهر أكبر بـ14٪ وأكثر إشراقاً بـ30٪ من البدر المتوسّط.' }
            ],
            en: [
