...
// MOON-PHASE-EVENT-ENGINE-MEEUS49-FIX-1 (2026-06-16):
//   v443 → v444. Major moon-phase EVENT TIMES are now computed with Meeus Ch.49
//   (true phase JDE) instead of mean-elongation-D crossing — the latter was off
//   by up to ~17h and flipped the local event day (June 2026 Full Moon showed 29
//   instead of 30 for Riyadh). Matches timeanddate to the minute; event-based
...
// MOON-PAGES-JS-ERRORS-FIX-1 (2026-06-30): js/app.js?v=805→806 + sw v466→v467. Null-guards in
